    ...
    return function(n) {
        ...
        e.exports = {
            init: function(e) {
                ...
                return !0 === (t = m.disable) || "mobile" === t && l.default.mobile() || "phone" === t && l.default.phone() || "tablet" === t && l.default.tablet() || "function" == typeof t && !0 === t() || n ? void p.forEach(function(e, t) {
                    ...
                    h(!0)
                }), window.addEventListener("resize", (0, r.default)(h, m.debounceDelay, !0)), window.addEventListener("orientationchange", (0, r.default)(h, m.debounceDelay, !0)), window.addEventListener("scroll", (0, o.default)(function() {
        ...
        (function(e) {
            ...
            function o(i, a, e) {
                ...
                function r(e) {
                    var t = e - m;
                    return void 0 === m || a <= t || t < 0 || g && d <= e - h
                }

                function s() {
                    var e, t, n = C();
                    return r(n) ? l(n) : void(f = setTimeout(s, (t = a - ((e = n) - m), g ? x(t, d - (e - h)) : t)))
                }

                function l(e) {
                    return f = void 0, n && c ? o(e) : (c = u = void 0, p)
                }
                ...
                function t() {
                    ...
                    if (c = arguments, u = this, m = t, n) {
                        if (void 0 === f) return h = e = m, f = setTimeout(s, a), v ? o(e) : p;
                        if (g) return f = setTimeout(s, a), o(m)
                    }
                    return void 0 === f && (f = setTimeout(s, a)), p
                }
                var c, u, d, p, f, m, h = 0,
                    v = !1,
                    g = !1,
                ...
                return a = b(a) || 0, y(e) && (v = !!e.leading, d = (g = "maxWait" in e) ? k(b(e.maxWait) || 0, a) : d, n = "trailing" in e ? !!e.trailing : n), t.cancel = function() {
            ...
            function b(e) {
                ...
                e = e.replace(s, "");
                var n = c.test(e);
                return n || u.test(e) ? d(e.slice(2), n ? 2 : 8) : l.test(e) ? a : +e
            }
            ...
            h.exports = function(e, t, n) {
                ...
                return y(n) && (i = "leading" in n ? !!n.leading : i, a = "trailing" in n ? !!n.trailing : a), o(e, t, {
                    leading: i,
                    maxWait: t,
                    trailing: a
                })
        ...
        (function(e) {
            ...
            function i(e) {
                return "symbol" == (void 0 === e ? "undefined" : n(e)) || !!(t = e) && "object" == (void 0 === t ? "undefined" : n(t)) && f.call(e) == o;
                var t
            }
        ...
        t.default = function(e, r) {
            ...
            e.forEach(function(e, t) {
                var n, i, a, o;
                i = l + s, a = r, o = (n = e).node.getAttribute("data-aos-once"), i > n.position ? n.node.classList.add("aos-animate") : void 0 !== o && ("false" === o || !a && "true" !== o) && n.node.classList.remove("aos-animate")
            })
        }
    }, function(e, t, n) {
        "use strict";
...
var DecorationsT, JobT, SourceSpansT, pJS = function(e, t) {
    ...
    t && Object.deepExtend(f, t), f.tmp.obj = {
        ...
        f.particles.move.straight ? (this.vx = a.x, this.vy = a.y, f.particles.move.random && (this.vx = this.vx * Math.random(), this.vy = this.vy * Math.random())) : (this.vx = a.x + Math.random() - .5, this.vy = a.y + Math.random() - .5), this.vx_i = this.vx, this.vy_i = this.vy;
        ...
        switch (f.canvas.ctx.fillStyle = i, f.canvas.ctx.beginPath(), e.shape) {
            ...
            case "image":
                ;
                if ("svg" == f.tmp.img_type) var a = e.img.obj;
                else a = f.tmp.img_obj;
                a && f.canvas.ctx.drawImage(a, e.x - t, e.y - t, 2 * t, 2 * t / e.img.ratio)
        }
        ...
        for (var e = 0; e < f.particles.array.length; e++) {
            ...
            if (isInArray("grab", f.interactivity.events.onhover.mode) && f.fn.modes.grabParticle(t), (isInArray("bubble", f.interactivity.events.onhover.mode) || isInArray("bubble", f.interactivity.events.onclick.mode)) && f.fn.modes.bubbleParticle(t), (isInArray("repulse", f.interactivity.events.onhover.mode) || isInArray("repulse", f.interactivity.events.onclick.mode)) && f.fn.modes.repulseParticle(t), f.particles.line_linked.enable || f.particles.move.attract.enable)
                for (var a = e + 1; a < f.particles.array.length; a++) {
                    var o = f.particles.array[a];
        ...
        var n = e.x - t.x,
            i = e.y - t.y,
            a = Math.sqrt(n * n + i * i);
        if (a <= f.particles.line_linked.distance) {
            var o = f.particles.line_linked.opacity - a / (1 / f.particles.line_linked.opacity) / f.particles.line_linked.distance;
            if (0 < o) {
                var r = f.particles.line_linked.color_rgb_line;
                f.canvas.ctx.strokeStyle = "rgba(" + r.r + "," + r.g + "," + r.b + "," + o + ")", f.canvas.ctx.lineWidth = f.particles.line_linked.width, f.canvas.ctx.beginPath(), f.canvas.ctx.moveTo(e.x, e.y), f.canvas.ctx.lineTo(t.x, t.y), f.canvas.ctx.stroke(), f.canvas.ctx.closePath()
            }
        }
        ...
        if (Math.sqrt(n * n + i * i) <= f.particles.line_linked.distance) {
            var a = n / (1e3 * f.particles.move.attract.rotateX),
        ...
        if (f.interactivity.events.onhover.enable && isInArray("bubble", f.interactivity.events.onhover.mode)) {
            ...
            if (l <= f.interactivity.modes.bubble.distance) {
                if (0 <= n && "mousemove" == f.interactivity.status) {
                    if (f.interactivity.modes.bubble.size != f.particles.size.value)
                        if (f.interactivity.modes.bubble.size > f.particles.size.value) {
                            0 <= (o = s.radius + f.interactivity.modes.bubble.size * n) && (s.radius_bubble = o)
                        } else {
                            var a = s.radius - f.interactivity.modes.bubble.size,
                                o = s.radius - a * n;
            ...
            function u(e, t, n, i, a) {
                if (e != t)
                    if (f.tmp.bubble_duration_end) null != n && (r = e + (e - (i - c * (i - e) / f.interactivity.modes.bubble.duration)), "size" == a && (s.radius_bubble = r), "opacity" == a && (s.opacity_bubble = r));
                    else if (l <= f.interactivity.modes.bubble.distance) {
                    if (null != n) var o = n;
                    else o = i;
                    if (o != e) {
                        var r = i - c * (i - e) / f.interactivity.modes.bubble.duration;
                        "size" == a && (s.radius_bubble = r), "opacity" == a && (s.opacity_bubble = r)
                    }
                } else "size" == a && (s.radius_bubble = void 0), "opacity" == a && (s.opacity_bubble = void 0)
            }
        ...
        if (f.interactivity.events.onhover.enable && "mousemove" == f.interactivity.status) {
            ...
            if (i <= f.interactivity.modes.grab.distance) {
                var a = f.interactivity.modes.grab.line_linked.opacity - i / (1 / f.interactivity.modes.grab.line_linked.opacity) / f.interactivity.modes.grab.distance;
                if (0 < a) {
                    var o = f.particles.line_linked.color_rgb_line;
                    f.canvas.ctx.strokeStyle = "rgba(" + o.r + "," + o.g + "," + o.b + "," + a + ")", f.canvas.ctx.lineWidth = f.particles.line_linked.width, f.canvas.ctx.beginPath(), f.canvas.ctx.moveTo(e.x, e.y), f.canvas.ctx.lineTo(f.interactivity.mouse.pos_x, f.interactivity.mouse.pos_y), f.canvas.ctx.stroke(), f.canvas.ctx.closePath()
                }
            }
        }
        ...
        for (var n = 0; n < f.particles.array.length; n++) {
            var i = f.particles.array[n],
                a = e.x - i.x,
                o = e.y - i.y;
            Math.sqrt(a * a + o * o) <= e.radius + i.radius && (e.x = t ? t.x : Math.random() * f.canvas.w, e.y = t ? t.y : Math.random() * f.canvas.h, f.fn.vendors.checkOverlap(e))
        }
    }, f.fn.vendors.createSvgImg = function(o) {
        var e = f.tmp.source_svg.replace(/#([0-9A-F]{3,6})/gi, function(e, t, n, i) {
                if (o.color.rgb) var a = "rgba(" + o.color.rgb.r + "," + o.color.rgb.g + "," + o.color.rgb.b + "," + o.opacity + ")";
                else a = "hsla(" + o.color.hsl.h + "," + o.color.hsl.s + "%," + o.color.hsl.l + "%," + o.opacity + ")";
                return a
            }),
            t = new Blob([e], {
        ...
        a.addEventListener("load", function() {
            o.img.obj = a, o.img.loaded = !0, n.revokeObjectURL(i), f.tmp.count_svg++
        }), a.src = i
    }, f.fn.vendors.destroypJS = function() {
        cancelAnimationFrame(f.fn.drawAnimFrame), n.remove(), pJSDom = null
    }, f.fn.vendors.drawShape = function(e, t, n, i, a, o) {
        var r = a * o,
            s = a / o,
            l = 180 * (s - 2) / s,
...
Object.deepExtend = function(e, t) {
        ...
        if (a.length)
            for (; 0 < a.length;) n.removeChild(a[0]);
        ...
        a.open("GET", e), a.onreadystatechange = function(e) {
            if (4 == a.readyState)
                if (200 == a.status) {
            ...
            var a = n(1),
                ...
                o = function() {
                    function n(e, t) {
                        ! function(e, t) {
                            if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
                        }(this, n), a.initializer.load(this, t, e), this.begin()
                    }
                    return i(n, [{
                        key: "toggle",
                        value: function() {
                        ...
                        value: function(n, i) {
                            ...
                            if (!0 !== this.pause.status) {
                                ...
                                this.timeout = setTimeout(function() {
                                    i = u.htmlParser.backSpaceHtmlChars(n, i, a);
                                    var e = n.substr(0, i);
                                    if (a.replaceText(e), a.smartBackspace) {
                                        var t = a.strings[a.arrayPos + 1];
                                        t && e === t.substr(0, i) ? a.stopNum = i : a.stopNum = 0
                                    }
                                    i > a.stopNum ? (i--, a.backspace(n, i)) : i <= a.stopNum && (a.arrayPos++, a.arrayPos === a.strings.length ? (a.arrayPos = 0, a.options.onLastStringBackspaced(), a.shuffleStringsIfNeeded(), a.begin()) : a.typewrite(a.strings[a.sequence[a.arrayPos]], i))
                                }, e)
            ...
            var i = function() {
                    ...
                    return n(e, [{
                        ...
                        value: function(e, t, n) {
                            ...
                            if ("<" === i || "&" === i) {
                                var a = "";
                                for (a = "<" === i ? ">" : ";"; e.substr(t + 1).charAt(0) !== a && !(++t + 1 > e.length););
                                t++
                            }
                            return t
                        }
                        ...
                        value: function(e, t, n) {
                            ...
                            if (">" === i || ";" === i) {
                                var a = "";
                                for (a = ">" === i ? "<" : "&"; e.substr(t - 1).charAt(0) !== a && !(--t < 0););
                                t--
                            }
                            return t
                        }
...
"undefined" != typeof window && (window.PR_SHOULD_USE_CONTINUATION = PR_SHOULD_USE_CONTINUATION),
    function() {
        var P = "undefined" != typeof window ? window : {},
            ...
            o = [t, "abstract,async,await,constructor,debugger,enum,eval,export,from,function,get,import,implements,instanceof,interface,let,null,of,set,undefined,var,with,yield,Infinity,NaN"],
        ...
        function O(e, t, n, i, a) {
            if (n) {
                ...
                i(o), a.push.apply(a, o.decorations)
            }
        }
        var y = /\S/;
        ...
        function b(u, k) {
            var x, C = {};
            ! function() {
                for (var e = u.concat(k), t = [], n = {}, i = 0, a = e.length; i < a; ++i) {
                    var o = e[i],
                        r = o[3];
                    if (r)
                        for (var s = r.length; 0 <= --s;) C[r.charAt(s)] = o;
                    var l = o[1],
                        c = "" + l;
                ...
                t.push(/[\0-\uffff]/), x = function(e) {
                    ...
                    function d(e) {
                        var t = e.substring(1, e.length - 1).match(new RegExp("\\\\u[0-9A-Fa-f]{4}|\\\\x[0-9A-Fa-f]{2}|\\\\[0-3][0-7]{0,2}|\\\\[0-7]{1,2}|\\\\[\\s\\S]|-|[^-\\\\]", "g")),
                            ...
                            a = ["["];
                        i && a.push("^");
                        for (var o = i ? 1 : 0, r = t.length; o < r; ++o) {
                            var s = t[o];
                            if (/\\[bdsw]/i.test(s)) a.push(s);
                            else {
                                var l, c = f(s);
                                o + 2 < r && "-" === t[o + 1] ? (l = f(t[o + 2]), o += 2) : l = c, n.push([c, l]), l < 65 || 122 < c || (l < 65 || 90 < c || n.push([32 | Math.max(65, c), 32 | Math.min(l, 90)]), l < 97 || 122 < c || n.push([-33 & Math.max(97, c), -33 & Math.min(l, 122)]))
                            }
                        }
                        n.sort(function(e, t) {
                        ...
                        var u = [],
                            d = [];
                        for (o = 0; o < n.length; ++o)(p = n[o])[0] <= d[1] + 1 ? d[1] = Math.max(d[1], p[1]) : u.push(d = p);
                        for (o = 0; o < u.length; ++o) {
                            var p = u[o];
                            a.push(m(p[0])), p[1] > p[0] && (p[1] + 1 > p[0] && a.push("-"), a.push(m(p[1])))
                        }
                        return a.push("]"), a.join("")
                    }

                    function o(e) {
                        for (var t = e.source.match(new RegExp("(?:\\[(?:[^\\x5C\\x5D]|\\\\[\\s\\S])*\\]|\\\\u[A-Fa-f0-9]{4}|\\\\x[A-Fa-f0-9]{2}|\\\\[0-9]+|\\\\[^ux0-9]|\\(\\?[:!=]|[\\(\\)\\^]|[^\\x5B\\x5C\\(\\)\\^]+)", "g")), n = t.length, i = [], a = 0, o = 0; a < n; ++a) "(" === (s = t[a]) ? ++o : "\\" === s.charAt(0) && (r = +s.substring(1)) && (r <= o ? i[r] = -1 : t[a] = m(r));
                        for (a = 1; a < i.length; ++a) - 1 === i[a] && (i[a] = ++c);
                        for (o = a = 0; a < n; ++a)
                            if ("(" === (s = t[a])) i[++o] || (t[a] = "(?:");
                            else if ("\\" === s.charAt(0)) {
                            var r;
                            (r = +s.substring(1)) && r <= o && (t[a] = "\\" + i[r])
                        }
                        for (a = 0; a < n; ++a) "^" === t[a] && "^" !== t[a + 1] && (t[a] = "");
                        if (e.ignoreCase && u)
                            for (a = 0; a < n; ++a) {
                                var s, l = (s = t[a]).charAt(0);
                                2 <= s.length && "[" === l ? t[a] = d(s) : "\\" !== l && (t[a] = s.replace(/[a-zA-Z]/g, function(e) {
                                    var t = e.charCodeAt(0);
            ...
            var S = k.length,
                _ = function(e) {
                    for (var t = e.sourceCode, n = e.basePos, i = e.sourceNode, a = [n, T], o = 0, r = t.match(x) || [], s = {}, l = 0, c = r.length; l < c; ++l) {
                        var u, d = r[l],
                            p = s[d],
                            f = void 0;
                        ...
                        if (o += d.length, u) {
                            ...
                            var w = p.substring(5);
                            O(i, n + v, d.substring(0, y), _, a), O(i, n + v + y, g, M(w, g), a), O(i, n + v + b, d.substring(b), _, a)
                        } else a.push(n + v, p)
                    }
                    e.decorations = a
                };
        ...
        function w(e) {
            ...
            if (a) {
                var o = 1 < a ? "" : "\n\r",
                    r = o ? "." : "[\\S\\s]",
                    s = "/(?=[^/*" + o + "])(?:[^/\\x5B\\x5C" + o + "]|\\x5C" + r + "|\\x5B(?:[^\\x5C\\x5D" + o + "]|\\x5C" + r + ")*(?:\\x5D|$))+/";
        ...
        function I(e, t, s) {
                ...
                if (1 != t || l.test(e.className)) {
                    if ((3 == t || 4 == t) && s) {
                        var n = e.nodeValue,
                            i = n.match(c);
                        if (i) {
                            var a = n.substring(0, i.index);
                            e.nodeValue = a;
                            var o = n.substring(i.index + i[0].length);
                            if (o) e.parentNode.insertBefore(u.createTextNode(o), e.nextSibling);
                ...
                for (var t, n = function e(t, n) {
                        ...
                        if (a) {
                            var o = e(a, 1),
                                r = t.nextSibling;
                            o.appendChild(i);
                            for (var s = r; s; s = r) r = s.nextSibling, o.appendChild(s)
                        }
                        return i
                    }(e.nextSibling, 0);
            ...
            for (var a = 0; a < i.length; ++a) d(i[a]);
            t === (0 | t) && i[0].setAttribute("value", t);
            var o = u.createElement("ol");
            o.className = "linenums";
            for (var r = Math.max(0, t - 1 | 0) || 0, f = (a = 0, i.length); a < f; ++a)(n = i[a]).className = "L" + (a + r) % 10, n.firstChild || n.appendChild(u.createTextNode(" ")), o.appendChild(n);
            e.appendChild(o)
        }
        var x = {};
            ...
            try {
                var i = (t = e.sourceNode, r = e.pre, s = /(?:^|\s)nocode(?:\s|$)/, l = [], u = [], d = c = 0, function e(t) {
                        ...
                        if (1 == n) {
                            ...
                            var o = t.nodeValue;
                            o.length && (o = r ? o.replace(/\r\n?/g, "\n") : o.replace(/[ \t\r\n]+/g, " "), l[d] = o, u[d << 1] = c, c += o.length, u[d++ << 1 | 1] = t)
                        }
                    }(t), {
                    ...
                    a = i.sourceCode;
                e.sourceCode = a, e.spans = i.spans, e.basePos = 0, M(n, a)(e),
                    function(e) {
                        ...
                        try {
                            for (; u < c;) {
                                ...
                                if (1 !== x.nodeType && (b = o.substring(s, v))) {
                                    t && (b = b.replace(a, "\r")), x.nodeValue = b;
                                    var C = x.ownerDocument,
                                        S = C.createElement("span");
                                    S.className = d[f + 1];
                                    var _ = x.parentNode;
                                    _.replaceChild(S, x), S.appendChild(x), s < w && (l[u + 1] = x = C.createTextNode(o.substring(v, w)), _.insertBefore(x, S.nextSibling))
                                }
                                w <= (s = v) && (u += 2), k <= s && (f += 2)
                            }
                        } finally {
        ...
        function S(e, t, n) {
            ...
            return o.innerHTML = "<pre>" + e + "</pre>", o = o.firstChild, i && I(o, i, !0), L({
                langExtension: a,
                numberLines: i,
                sourceNode: o,
                pre: 1,
        ...
        function _(y, e) {
            ...
            for (var i = [n("pre"), n("code"), n("xmp")], w = [], a = 0; a < i.length; ++a)
                for (var o = 0, r = i[a].length; o < r; ++o) w.push(i[a][o]);
            i = null;
            var k = Date;
            k.now || (k = {
                now: function() {
            ...
            ! function e() {
                for (var t = P.PR_SHOULD_USE_CONTINUATION ? k.now() + 250 : 1 / 0; x < w.length && k.now() < t; x++) {
                    for (var n = w[x], i = M, a = n; a = a.previousSibling;) {
                        var o = a.nodeType,
                            r = (7 === o || 8 === o) && a.nodeValue;
                        if (r ? !/^\??prettify\b/.test(r) : 3 !== o || /\S/.test(a.nodeValue)) break;
                        if (r) {
                    ...
                    var s = n.className;
                    if ((i !== M || S.test(s)) && !_.test(s)) {
                        for (var l = !1, c = n.parentNode; c; c = c.parentNode) {
                            var u = c.tagName;
                            if (O.test(u) && c.className && S.test(c.className)) {
                                l = !0;
                                break
                            }
                        }
                        if (!l) {
                            ...
                            var g = i.linenums;
                            (g = "true" === g || +g) || (g = !!(g = s.match(/\blinenums\b(?::(\d+))?/)) && (!g[1] || !g[1].length || +g[1])), g && I(n, g, p), L({
                                langExtension: f,
                                sourceNode: n,
                                numberLines: g,
                                pre: p,
        ...
        var N = P.PR = {
            ...
            z = P.define;
        "function" == typeof z && z.amd && z("google-code-prettify", [], function() {
            return N
        })
    }(),
    function(e) {
        ...
        var d, i, p, a, f, t, l = "Close",
            ...
            w = function(e, t, n, i) {
                ...
                return a.className = "mfp-" + e, n && (a.innerHTML = n), i ? t && t.appendChild(a) : (a = u(a), t && a.appendTo(t)), a
            },
            k = function(e, t) {
        ...
        e.prototype = {
            ...
            updateItemHTML: function() {
                ...
                a && a !== e.type && d.container.removeClass("mfp-" + a + "-holder");
                var i = d["get" + t.charAt(0).toUpperCase() + t.slice(1)](e, d.currTemplate[t]);
                d.appendContent(i, t), e.preloaded = !0, k("Change", e), a = e.type, d.container.prepend(d.contentContainer), k("AfterChange")
            },
            ...
            parseEl: function(e) {
                ...
                if (n.tagName ? n = {
                    ...
                    for (var i = d.types, a = 0; a < i.length; a++)
            ...
            _parseMarkup: function(a, e, t) {
                var o;
                t.data && (e = u.extend(t.data, e)), k(m, [a, e, t]), u.each(e, function(e, t) {
            ...
            if ("string" == typeof e)
                if ("open" === e) {
                    ...
                    i.items ? n = i.items[a] : (n = t, i.delegate && (n = n.find(i.delegate)), n = n.eq(a)), d._openClick({
                        mfpEl: n
                    }, t, i)
                ...
                getInline: function(e, t) {
                    if (E(), e.src) {
                        ...
                        if (i.length) {
                            ...
                            a && a.tagName && (S || (C = n.hiddenClass, S = w(C), C = "mfp-" + C), _ = i.after(S).detach().removeClass(C)), d.updateStatus("ready")
        ...
        var O, M = "ajax",
            P = function() {
                O && u(document.body).removeClass(O)
            },
            A = function() {
                P(), d.req && d.req.abort()
            };
        u.magnificPopup.registerModule(M, {
            ...
            proto: {
                initAjax: function() {
                    d.types.push(M), O = d.st.ajax.cursor, b(l + "." + M, A), b("BeforeChange." + M, A)
                },
                getAjax: function(a) {
                    O && u(document.body).addClass(O), d.updateStatus("loading");
                    var e = u.extend({
                        url: a.src,
                        success: function(e, t, n) {
                            ...
                            k("ParseAjax", i), d.appendContent(u(i.data), M), a.finished = !0, P(), d._setFocus(), setTimeout(function() {
                                d.wrap.addClass(g)
                            }, 16), d.updateStatus("ready"), k("AjaxContentAdded")
                        },
                        error: function() {
                            P(), a.finished = a.loadError = !0, d.updateStatus("error", d.st.ajax.tError.replace("%url%", a.src))
                        }
                    }, d.st.ajax.settings);
        ...
        u.magnificPopup.registerModule("image", {
            ...
            proto: {
                ...
                _onImageHasSize: function(e) {
                    e.img && (e.hasSize = !0, I && clearInterval(I), e.isCheckingImgSize = !1, k("ImageHasSize", e), e.imgHidden && (d.content && d.content.removeClass("mfp-loading"), e.imgHidden = !1))
                },
                    ...
                    var n = 0,
                        ...
                        a = function(e) {
                            I && clearInterval(I), I = setInterval(function() {
                                0 < i.naturalWidth ? d._onImageHasSize(t) : (200 < n && clearInterval(I), 3 === ++n ? a(10) : 40 === n ? a(50) : 100 === n && a(500))
                            }, e)
                        };
                    a(1)
                },
                getImage: function(e, t) {
                    var n = 0,
                        i = function() {
                            e && (e.img[0].complete ? (e.img.off(".mfploader"), e === d.currItem && (d._onImageHasSize(e), d.updateStatus("ready")), e.hasSize = !0, e.loaded = !0, k("ImageLoadComplete")) : ++n < 200 ? setTimeout(i, 100) : a())
                        },
                        a = function() {
                    ...
                    if (r.length) {
                        ...
                        s.className = "mfp-img", e.el && e.el.find("img").length && (s.alt = e.el.find("img").attr("alt")), e.img = u(s).on("load.mfploader", i).on("error.mfploader", a), s.src = e.src, r.is("img") && (e.img = e.img.clone()), 0 < (s = e.img[0]).naturalWidth ? e.hasSize = !0 : s.width || (e.hasSize = !1)
                    }
                    ...
                    }, e), d.resizeImage(), e.hasSize ? (I && clearInterval(I), e.loadError ? (t.addClass("mfp-loading"), d.updateStatus("error", o.tError.replace("%url%", e.src))) : (t.removeClass("mfp-loading"), d.updateStatus("ready"))) : (d.updateStatus("loading"), e.loading = !0, e.hasSize || (e.imgHidden = !0, t.addClass("mfp-loading"), d.findImageSize(e))), t
                }
            }
        });
        var L;
        u.magnificPopup.registerModule("zoom", {
            ...
            proto: {
                initZoom: function() {
                    ...
                    if (o.enabled && d.supportsTransition) {
                        var n, i, a = o.duration,
                            r = function(e) {
                                var t = e.clone().removeAttr("style").removeAttr("class").addClass("mfp-animated-image"),
                                    ...
                                    a = "transition";
                                return i["-webkit-" + a] = i["-moz-" + a] = i["-o-" + a] = i[a] = n, t.css(i), t
                            },
                            s = function() {
                        ...
                        b("BuildControls" + t, function() {
                            ...
                            if (d._allowZoom()) {
                                if (clearTimeout(n), d.st.removalDelay = a, !e) {
                ...
                _getOffset: function(e) {
                    ...
                    var o = {
                        width: t.width(),
                        height: (s ? t.innerHeight() : t[0].offsetHeight) - a - i
                    };
        ...
        u.magnificPopup.registerModule(N, {
            ...
            proto: {
                ...
                getIframe: function(e, t) {
                    ...
                    var a = {};
                    return i.srcAction && (a[i.srcAction] = n), d._parseMarkup(t, a, e), d.updateStatus("ready"), t
                }
            }
        });
        var j = function(e) {
            ...
            proto: {
                initGallery: function() {
                    ...
                    f += " mfp-gallery", b(h + e, function() {
                        ...
                        t.text && (t.text = B(t.text, d.currItem.index, d.items.length))
                    }), b(m + e, function(e, t, n, i) {
                        var a = d.items.length;
                        n.counter = 1 < a ? B(o.tCounter, i.index, a) : ""
                    }), b("BuildControls" + e, function() {
                        if (1 < d.items.length && o.arrows && !d.arrowLeft) {
                            var e = o.arrowMarkup,
                                t = d.arrowLeft = u(e.replace(/%title%/gi, o.tPrev).replace(/%dir%/gi, "left")).addClass(r),
                                n = d.arrowRight = u(e.replace(/%title%/gi, o.tNext).replace(/%dir%/gi, "right")).addClass(r);
                            t.click(function() {
                                d.prev()
                            }), n.click(function() {
                                d.next()
    ...
    function() {
        ...
        l = /^\(?([^)]*)\)?(?:(.)(d+))?$/, p = 2e3, f = 2, m = 1e3 / 30, t = document.createElement("div").style, c = null != t.transition || null != t.webkitTransition || null != t.mozTransition || null != t.oTransition, v = window.requestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame || window.msRequestAnimationFrame, e = window.MutationObserver || window.WebKitMutationObserver || window.MozMutationObserver, a = function(e) {
            ...
            if (!s && null != window.jQuery) {
                for (s = !0, a = [], t = 0, n = (i = ["html", "text"]).length; t < n; t++) e = i[t], a.push(function(e) {
                    var n;
        ...
        })(), setTimeout(o, 0), (r = function() {
            function d(e) {
                var t, n, i, a, o, r, s, l, c, u = this;
                ...
                null == (a = this.options).duration && (a.duration = p), this.MAX_VALUES = this.options.duration / m / f | 0, this.resetFormat(), this.value = this.cleanValue(null != (l = this.options.value) ? l : ""), this.renderInside(), this.render();
                try {
                    for (o = 0, r = (c = ["innerHTML", "innerText", "textContent"]).length; o < r; o++) n = c[o], null != this.el[n] && function(t) {
            ...
            return d.prototype.renderInside = function() {
                ...
                var e, t, n, i, a, o, r = this;
                if (!this.transitionEndBound) {
                    for (this.transitionEndBound = !0, t = !1, o = [], n = 0, i = (a = "transitionend webkitTransitionEnd oTransitionEnd otransitionend MSTransitionEnd".split(" ")).length; n < i; n++) e = a[n], o.push(this.el.addEventListener(e, function() {
                ...
                return o = (s = n.slice(1, 4))[0], a = s[1], i = (null != (t = s[2]) ? t.length : void 0) || 0, this.format = {
                    repeating: o,
                    radix: a,
                    precision: i
                }
                ...
                var t, n, i, a, o, r, s;
                for (null == e && (e = this.value), this.stopWatchingMutations(), this.resetFormat(), this.inside.innerHTML = "", o = this.options.theme, a = [], r = 0, s = (t = this.el.className.split(" ")).length; r < s; r++)(n = t[r]).length && ((i = /^odometer-theme-(.+)$/.exec(n)) ? o = i[1] : /^odometer(-|$)/.test(n) || a.push(n));
                return a.push("odometer"), c || a.push("odometer-no-transitions"), o ? a.push("odometer-theme-" + o) : a.push("odometer-auto-theme"), this.el.className = a.join(" "), this.ribbons = {}, this.formatDigits(e), this.startWatchingMutations()
            }, d.prototype.formatDigits = function(e) {
                var t, n, i, a, o, r, s, l, c;
                if (this.digits = [], this.options.formatFunction)
                    for (a = 0, r = (l = this.options.formatFunction(e).split("").reverse()).length; a < r; a++)(n = l[a]).match(/0-9/) ? ((t = this.renderDigit()).querySelector(".odometer-value").innerHTML = n, this.digits.push(t), this.insertDigit(t)) : this.addSpacer(n);
                else
                    for (i = !this.format.precision || !u(e) || !1, o = 0, s = (c = e.toString().split("").reverse()).length; o < s; o++) "." === (t = c[o]) && (i = !0), this.addDigit(t, i)
            }, d.prototype.update = function(e) {
                var t, n = this;
                return (t = (e = this.cleanValue(e)) - this.value) ? (i(this.el, "odometer-animating-up odometer-animating-down odometer-animating"), O(this.el, 0 < t ? "odometer-animating-up" : "odometer-animating-down"), this.stopWatchingMutations(), this.animate(e), this.startWatchingMutations(), setTimeout(function() {
                ...
                var i;
                return (i = a('<span class="odometer-formatting-mark"></span>')).innerHTML = e, n && O(i, n), this.insertDigit(i, t)
                ...
                if (t)
                    for (a = !1;;) {
                        if (!this.format.repeating.length) {
                            if (a) throw new Error("Bad odometer format without digits");
                            this.resetFormat(), a = !0
                        }
                ...
                if (a = +n - this.value) return r = o = h(), i = this.value, (s = function() {
                    var e, t;
                    return h() - r > l.options.duration ? (l.value = n, l.render(), void g(l.el, "odometerdone")) : (50 < (e = h() - o) && (o = h(), t = e / l.options.duration, i += a * t, l.render(Math.round(i))), null != v ? v(s) : setTimeout(s, 50))
                })()
            }, d.prototype.getDigitCount = function() {
                var e, t, n, i, a, o;
                for (e = a = 0, o = (i = 1 <= arguments.length ? w.call(arguments, 0) : []).length; a < o; e = ++a) n = i[e], i[e] = Math.abs(n);
                return t = Math.max.apply(Math, i), Math.ceil(Math.log(t + 1) / Math.log(10))
            }, d.prototype.getFractionalDigitCount = function() {
                var e, t, n, i, a, o, r;
                for (t = /^\-?\d*\.(\d*?)0*$/, e = o = 0, r = (a = 1 <= arguments.length ? w.call(arguments, 0) : []).length; o < r; e = ++o) i = a[e], a[e] = i.toString(), n = t.exec(a[e]), a[e] = null == n ? 0 : n[1].length;
                return Math.max.apply(Math, a)
            }, d.prototype.resetDigits = function() {
                return this.digits = [], this.ribbons = [], this.inside.innerHTML = "", this.resetFormat()
            }, d.prototype.animateSlide = function(e) {
                var t, n, i, a, o, r, s, l, c, u, d, p, f, m, h, v, g, y, b, w, k, x, C, S, _, T, E;
                if (v = this.value, (l = this.getFractionalDigitCount(v, e)) && (e *= Math.pow(10, l), v *= Math.pow(10, l)), i = e - v) {
                    for (this.bindTransitionEnd(), a = this.getDigitCount(v, e), o = [], d = b = t = 0; 0 <= a ? b < a : a < b; d = 0 <= a ? ++b : --b) {
                        if (g = M(v / Math.pow(10, a - d - 1)), r = (s = M(e / Math.pow(10, a - d - 1))) - g, Math.abs(r) > this.MAX_VALUES) {
                    ...
                    for (this.resetDigits(), d = k = 0, C = (T = o.reverse()).length; k < C; d = ++k)
                        for (u = T[d], this.digits[d] || this.addDigit(" ", l <= d), null == (y = this.ribbons)[d] && (y[d] = this.digits[d].querySelector(".odometer-ribbon-inner")), this.ribbons[d].innerHTML = "", i < 0 && (u = u.reverse()), f = _ = 0, S = u.length; _ < S; f = ++_) c = u[f], (h = document.createElement("div")).className = "odometer-value", h.innerHTML = c, this.ribbons[d].appendChild(h), f === u.length - 1 && O(h, "odometer-last-value"), 0 === f && O(h, "odometer-first-value");
            ...
            if (window.odometerOptions) {
                for (e in a = [], i = window.odometerOptions) t = i[e], a.push(null != (n = r.options)[e] ? (n = r.options)[e] : n[e] = t);
                return a
            }
        }, 0), r.init = function() {
            var e, t, n, i, a, o;
            if (null != document.querySelectorAll) {
                for (o = [], n = 0, i = (t = document.querySelectorAll(r.options.selector || ".odometer")).length; n < i; n++) e = t[n], o.push(e.odometer = new r({
                    el: e,
                    value: null != (a = e.innerText) ? a : e.textContent
                }));
                return o
            }
        ...
        if (!d.hasInitialised) {
            var p = {
                ...
                setCookie: function(e, t, n, i, a, o) {
                    ...
                    var s = [e + "=" + t, "expires=" + r.toUTCString(), "path=" + (a || "/")];
                ...
                getLuminance: function(e) {
                    var t = parseInt(this.normaliseHex(e), 16),
                        ...
                        i = 38 + (t >> 8 & 255),
                        a = 38 + (255 & t);
                    return "#" + (16777216 + 65536 * (n < 255 ? n < 1 ? 0 : n : 255) + 256 * (i < 255 ? i < 1 ? 0 : i : 255) + (a < 255 ? a < 1 ? 0 : a : 255)).toString(16).slice(1)
                },
                isMobile: function() {
            ...
            d.customStyles = {}, d.Popup = function() {
                        ...
                        function(e) {
                            ...
                            return this.customStyleSelector = i ? n : null, i && function(e, t, n) {
                                ...
                                var i = {},
                                    ...
                                    o = t.button,
                                    r = t.highlight;
                                a && (a.text = a.text ? a.text : p.getContrast(a.background), a.link = a.link ? a.link : a.text, i[n + ".cc-window"] = ["color: " + a.text, "background-color: " + a.background], i[n + ".cc-revoke"] = ["color: " + a.text, "background-color: " + a.background], i[n + " .cc-link," + n + " .cc-link:active," + n + " .cc-link:visited"] = ["color: " + a.link], o && (o.text = o.text ? o.text : p.getContrast(o.background), o.border = o.border ? o.border : "transparent", i[n + " .cc-btn"] = ["color: " + o.text, "border-color: " + o.border, "background-color: " + o.background], o.padding && i[n + " .cc-btn"].push("padding: " + o.padding), "transparent" != o.background && (i[n + " .cc-btn:hover, " + n + " .cc-btn:focus"] = ["background-color: " + (o.hover || (s = o.background, "000000" == (s = p.normaliseHex(s)) ? "#222" : p.getLuminance(s)))]), r ? (r.text = r.text ? r.text : p.getContrast(r.background), r.border = r.border ? r.border : "transparent", i[n + " .cc-highlight .cc-btn:first-child"] = ["color: " + r.text, "border-color: " + r.border, "background-color: " + r.background]) : i[n + " .cc-highlight .cc-btn:first-child"] = ["color: " + a.text]));
                                var s;
                ...
                function r(e) {
                    ...
                    n.innerHTML = e;
                    var a = n.children[0];
                    return a.style.display = "none", p.hasClass(a, "cc-window") && d.hasTransition && p.addClass(a, "cc-invisible"), this.onButtonClick = function(e) {
                    ...
                    }.bind(this), a.addEventListener("click", this.onButtonClick), t.autoAttach && (i.firstChild ? i.insertBefore(a, i.firstChild) : i.appendChild(a)), a
                }

                function s(e, t) {
                    for (var n = 0, i = e.length; n < i; ++n) {
                        var a = e[n];
                        if (a instanceof RegExp && a.test(t) || "string" == typeof a && a.length && a === t) return !0
                    }
                    return !1
                }
                var l = {
                ...
                return e.prototype.initialise = function(e) {
                    ...
                    var t = this.options.window.replace("{{classes}}", o.call(this).join(" ")).replace("{{children}}", function() {
                            var t = {},
                                n = this.options;
                    ...
                    (function() {
                        ...
                        if (i) {
                            var c = function(e) {
                                for (var t = !1, n = e.path.length, i = l.length, a = 0; a < n; a++)
                                    if (!t)
                                        for (var o = 0; o < i; o++) t || (t = p.hasClass(e.path[a], l[o]));
                ...
                function t(e, t, n) {
                    ...
                    a.type = "text/" + (e.type || "javascript"), a.src = e.src || e, a.async = !1, a.onreadystatechange = a.onload = function() {
                        var e = a.readyState;
                        clearTimeout(i), t.done || e && !/loaded|complete/.test(e) || (t.done = !0, t(), a.onreadystatechange = a.onload = null)
                    }, document.body.appendChild(a), i = setTimeout(function() {
                        t.done = !0, t(), a.onreadystatechange = a.onload = null
                    }, n)
                }

                function o(e, t, n, i, a) {
                    var o = new(window.XMLHttpRequest || window.ActiveXObject)("MSXML2.XMLHTTP.3.0");
                    if (o.open(i ? "POST" : "GET", e, 1), o.setRequestHeader("Content-type", "application/x-www-form-urlencoded"), Array.isArray(a))
                ...
                return e.prototype.getNextService = function() {
                    ...
                    var a = this.getCurrentServiceOpts();
                    return i.url.replace(/\{(.*?)\}/g, function(e, t) {
                        ...
                        if (t in a.interpolateUrl) return a.interpolateUrl[t]
                    })
                }, e.prototype.runService = function(n, i) {
                    var a = this;
                    n && n.url && n.callback && (n.isScript ? t : o)(this.setupUrl(n), function(e) {
                        var t = e ? e.responseText : "";
                        n.__JSONP_DATA && (t = n.__JSONP_DATA, delete n.__JSONP_DATA), a.runServiceCallback.call(a, i, n, t)
                    }, this.options.timeout, n.data, n.headers)
                }, e.prototype.runServiceCallback = function(t, e, n) {
                    var i = this,
                        a = e.callback(function(e) {
                            a || i.onServiceResult.call(i, t, e)
                        }, n);
                    a && this.onServiceResult.call(this, t, a)
                ...
                var a = new d.Law(t.law);
                n || (n = function() {}), i || (i = function() {});
                var e = Object.keys(d.status),
                    o = p.getCookie("cookieconsent_status");
                return 0 <= e.indexOf(o) ? void n(new d.Popup(t)) : void d.getCountryCode(t, function(e) {
                    delete t.law, delete t.location, e.code && (t = a.applyLaw(t, e.code)), n(new d.Popup(t))
                }, function(e) {
        ...
        C(function() {
            C(".swiper-container").each(function() {
                ...
                d && C(d).on("click", ".nav-item", function(e) {
                    ...
                    return k.slideTo(i - 1), f ? (t.siblings().each(function() {
    ...
    function(c) {
        ...
        fillSelect: function(e, t, n, i) {
            if (e) {
                var a = "";
                for (var o in "function" != typeof i && (i = this.getSimpleOption), t) a += i(t[o], o, o == n);
                e.innerHTML = a
            }
        },
        ...
        tabularObject: function(e, t, n) {
            ...
            for (var o in "function" != typeof n && (n = a), "function" != typeof t && (t = a), e) i += "<li><em>" + n(o, e[o]) + "</em> " + t(e[o], o) + "</li>";
            return i + "</ul>"
        },
        initialisePopupSelector: function(i) {
            if (i.selector) {
                ...
                i.selector.innerHTML = t + Object.keys(i.popups).join(n + t) + n, i.selector.onclick = function(e) {
                    ...
                    if (!t.isEqualNode(i.selector)) {
                        ...
                        if (t.parentNode.isEqualNode(i.selector)) {
                            ...
                            0 <= n && a[n] && (a[n].clearStatus(), a.forEach(function(e) {
                ...
                for (var o = 0, r = e.length; o < r; ++o) {
                    i.popups[e[o]].onPopupOpen = function(t) {
                        return function() {
                    ...
                    s.autoOpen = !1, i.cookieconsent.initialise(s, function(e, t) {
                        a[e] = t
                    }.bind(null, o), function(e, t, n) {
                        a[e] = n, console.error(t)
                    }.bind(null, o))
                }
                return a
            }
...
! function(e, n) {
    ...
    t && (n.fillSelect(t, COUNTRY_CODES, COUNTRY_CODES.AC), t.onchange = function() {
        ...
        var i = $("#accordion-theme-current"),
            a = $("#accordion-colored");
        a.addClass("accordion-" + a.data("current")), i.addClass("btn-outline-" + a.data("current")), $("#demo-accordion-theme-selector").on("click", ".dropdown-item", function(e) {
            e.preventDefault();
            var t = $(this).data("color"),
                n = a.data("current");
            a.removeClass("accordion-" + n).addClass("accordion-" + t), a.data("current", t), i.html(t), i.removeClass("btn-outline-" + n).addClass("btn-outline-" + t)
        ...
        d("form").each(function() {
            ...
            t.addClass("loading");
            var i, a, o, r, s, l = t.parent(".ajax-button"),
                c = l.length,
                u = n.next(".response-message");
            return a = (i = n).attr("action"), o = i.serializeArray(), s = d.extend(!0, {}, r, {
                url: a,
                type: "POST",
                data: o,
                dataType: "json"
    ...
    function() {
        "use strict";
        for (var e, t = function() {}, n = ["assert", "clear", "count", "debug", "dir", "dirxml", "error", "exception", "group", "groupCollapsed", "groupEnd", "info", "log", "markTimeline", "profile", "profileEnd", "table", "time", "timeEnd", "timeline", "timelineEnd", "timeStamp", "trace", "warn"], i = n.length, a = window.console = window.console || {}; i--;) a[e = n[i]] || (a[e] = t)
    }(), $(function() {
        "use strict";
        var e = $(".main-nav"),
        ...
        if ($(window).on("scroll", a), a(), $("a.scrollto").on("click", function(e) {
                e.preventDefault();
                var t = this.hash;
            ...
            strings: ["Developing", "Technology", "Artificial intelligence", "Projects"],
            typeSpeed: 150,
            backDelay: 500,
            backSpeed: 50,
            loop: !0
        ...
        $(".counter").length && $(".counter").counterUp(), $(".modal-popup").each(function() {
                ...
                e && (o.zoom = {
                    enabled: !0,
                    duration: e
                }), a && (o.focus = a), $.each(["image", "gallery"], function() {
                    var e = t.data(this) || !1;
            ...
            function() {
                ...
                n.on("leaveStep", function(e, t, n, i) {
                    var a, o, r, s, l = $("#form-step-" + n, c);
                    return "forward" !== i || !l.length || !!l.valid() && (a = l, r = new $.Deferred, s = $.extend(!0, {}, o, {
                        url: a.attr("action"),
                        type: "POST",
                        ...
                        e.result ? (a.trigger("form.submitted", [e]), $("input, textarea", a).removeClass("error"), a.addClass("submitted")) : e.errors && $.each(e.errors, function(e, t) {
                            $("[name$='[" + e + "]']", a).addClass("error").tooltip({
                                title: t,
                                placement: "bottom",
                                trigger: "manual"
                            }).tooltip("show").on("focus", function() {
                    ...
                    }), 2 === n && $("input[type=radio]", a).on("change", function(e) {
