! function(e, t) {
    ...
    function M(e, t) {
        ...
        if (e)
            ...
            } else if (e.nodeType || e === $ || e === m) n.push(e);
    ...
    var t = {
        ...
        on: function() {
            ...
            function o(e) {
                ...
                if (t) {
                    ...
                    if (n.indexOf(e) < 0 && n.unshift(e), M(t).is(s)) a.apply(t, n);
                    else
                        for (var i = M(t).parents(), r = 0; r < i.length; r += 1) M(i[r]).is(s) && a.apply(i[r], n)
                }
            }
        ...
        css: function(e, t) {
            ...
            if (1 === arguments.length) {
                ...
                if (this[0]) return $.getComputedStyle(this[0], null).getPropertyValue(e)
            }
        ...
        prepend: function(e) {
            ...
            for (t = 0; t < this.length; t += 1)
                if ("string" == typeof e) {
                    ...
                    for (r.innerHTML = e, n = r.childNodes.length - 1; 0 <= n; n -= 1) i[t].insertBefore(r.childNodes[n], i[t].childNodes[0])
                } else if (e instanceof l)
    ...
    var e, n, i, B = {
            ...
            getTranslate: function(e, t) {
                ...
                return $.WebKitCSSMatrix ? (6 < (i = s.transform || s.webkitTransform).split(",").length && (i = i.split(", ").map(function(e) {
                    return e.replace(",", ".")
                }).join(", ")), r = new $.WebKitCSSMatrix("none" === i ? "" : i)) : n = (r = s.MozTransform || s.OTransform || s.MsTransform || s.msTransform || s.transform || s.getPropertyValue("transform").replace("translate(", "matrix(1, 0, 0, 1,")).toString().split(","), "x" === t && (i = $.WebKitCSSMatrix ? r.m41 : 16 === n.length ? parseFloat(n[12]) : parseFloat(n[4])), "y" === t && (i = $.WebKitCSSMatrix ? r.m42 : 16 === n.length ? parseFloat(n[13]) : parseFloat(n[5])), i || 0
            },
                ...
                for (var n = Object(e[0]), i = 1; i < e.length; i += 1) {
                    ...
                    if (null != r)
                        for (var s = Object.keys(Object(r)), a = 0, o = s.length; a < o; a += 1) {
                            ...
                            void 0 !== u && u.enumerable && (B.isObject(n[l]) && B.isObject(r[l]) ? B.extend(n[l], r[l]) : !B.isObject(n[l]) && B.isObject(r[l]) ? (n[l] = {}, B.extend(n[l], r[l])) : n[l] = r[l])
                        }
                }
                return n
            }
        ...
        F = (i = m.createElement("div"), {
            touch: $.Modernizr && !0 === $.Modernizr.touch || !!("ontouchstart" in $ || $.DocumentTouch && m instanceof $.DocumentTouch),
            pointerEvents: !(!$.navigator.pointerEnabled && !$.PointerEvent),
            prefixedPointerEvents: !!$.navigator.msPointerEnabled,
            transition: (n = i.style, "transition" in n || "webkitTransition" in n || "MozTransition" in n),
            transforms3d: $.Modernizr && !0 === $.Modernizr.csstransforms3d || (e = i.style, "webkitPerspective" in e || "MozPerspective" in e || "OPerspective" in e || "MsPerspective" in e || "perspective" in e),
            flexbox: function() {
    ...
    var o = {
        updateSize: function() {
            var e, t, n = this,
                i = n.$el;
            e = void 0 !== n.params.width ? n.params.width : i[0].clientWidth, t = void 0 !== n.params.height ? n.params.height : i[0].clientHeight, 0 === e && n.isHorizontal() || 0 === t && n.isVertical() || (e = e - parseInt(i.css("padding-left"), 10) - parseInt(i.css("padding-right"), 10), t = t - parseInt(i.css("padding-top"), 10) - parseInt(i.css("padding-bottom"), 10), B.extend(n, {
                width: e,
                height: t,
        ...
        updateSlides: function() {
            ...
            if (void 0 !== i) {
                ...
                for (var T, S = t.slidesPerColumn, C = x / S, _ = C - (t.slidesPerColumn * C - u), k = 0; k < u; k += 1) {
                    E = 0;
                    var A = l.eq(k);
                    ...
                    if ("none" !== A.css("display")) {
                        if ("auto" === t.slidesPerView) {
                            var I = $.getComputedStyle(A[0], null),
                                L = A[0].style.transform,
                                P = A[0].style.webkitTransform;
                            L && (A[0].style.transform = "none"), P && (A[0].style.webkitTransform = "none"), E = t.roundLengths ? e.isHorizontal() ? A.outerWidth(!0) : A.outerHeight(!0) : e.isHorizontal() ? A[0].getBoundingClientRect().width + parseFloat(I.getPropertyValue("margin-left")) + parseFloat(I.getPropertyValue("margin-right")) : A[0].getBoundingClientRect().height + parseFloat(I.getPropertyValue("margin-top")) + parseFloat(I.getPropertyValue("margin-bottom")), L && (A[0].style.transform = L), P && (A[0].style.webkitTransform = P), t.roundLengths && (E = Math.floor(E))
                        ...
                        l[k] && (l[k].swiperSlideSize = E), h.push(E), t.centeredSlides ? (y = y + E / 2 + b / 2 + g, 0 === b && 0 !== k && (y = y - i / 2 - g), 0 === k && (y = y - i / 2 - g), Math.abs(y) < .001 && (y = 0), t.roundLengths && (y = Math.floor(y)), w % t.slidesPerGroup == 0 && c.push(y), d.push(y)) : (t.roundLengths && (y = Math.floor(y)), w % t.slidesPerGroup == 0 && c.push(y), d.push(y), y = y + E + g), e.virtualSize += E + g, b = E, w += 1
                    }
                }
                if (e.virtualSize = Math.max(e.virtualSize, i) + f, r && s && ("slide" === t.effect || "coverflow" === t.effect) && n.css({
                        width: e.virtualSize + t.spaceBetween + "px"
                    }), F.flexbox && !t.setWrapperSize || (e.isHorizontal() ? n.css({
                        width: e.virtualSize + t.spaceBetween + "px"
                    }) : n.css({
                    ...
                    for (var N = 0; N < c.length; N += 1) {
                        var j = c[N];
                        t.roundLengths && (j = Math.floor(j)), c[N] < e.virtualSize + c[0] && T.push(j)
                    }
                    c = T
                }
                if (!t.centeredSlides) {
                    ...
                    for (var z = 0; z < c.length; z += 1) {
                        var H = c[z];
                        t.roundLengths && (H = Math.floor(H)), c[z] <= e.virtualSize - i && T.push(H)
                    }
        ...
        updateProgress: function(e) {
            ...
            var t = this,
                ...
                o = s,
                l = a;
            0 === i ? a = s = !(r = 0) : (s = (r = (e - t.minTranslate()) / i) <= 0, a = 1 <= r), B.extend(t, {
                progress: r,
                isBeginning: s,
                isEnd: a
    ...
    var u = {
        ...
        setTranslate: function(e, t) {
            var n = this,
                ...
                o = 0,
                l = 0;
            n.isHorizontal() ? o = i ? -e : e : l = e, r.roundLengths && (o = Math.floor(o), l = Math.floor(l)), r.virtualTranslate || (F.transforms3d ? s.transform("translate3d(" + o + "px, " + l + "px, 0px)") : s.transform("translate(" + o + "px, " + l + "px)")), n.previousTranslate = n.translate, n.translate = n.isHorizontal() ? o : l;
    ...
    var d = {
        slideTo: function(e, t, n, i) {
            ...
            h >= o.length && (h = o.length - 1), (c || a.initialSlide || 0) === (u || 0) && n && r.emit("beforeSlideChangeStart");
            var p, f = -o[h];
        ...
        slidePrev: function(e, t, n) {
            ...
            return void 0 !== p && (c = o.indexOf(p)) < 0 && (c = i.activeIndex - 1), i.slideTo(c, e, t, n)
        },
        ...
        slideToClickedSlide: function() {
            ...
            if (n.loop) {
                ...
                e = parseInt(M(t.clickedSlide).attr("data-swiper-slide-index"), 10), n.centeredSlides ? s < t.loopedSlides - r / 2 || s > t.slides.length - t.loopedSlides + r / 2 ? (t.loopFix(), s = i.children("." + n.slideClass + '[data-swiper-slide-index="' + e + '"]:not(.' + n.slideDuplicateClass + ")").eq(0).index(), B.nextTick(function() {
                    t.slideTo(s)
                })) : t.slideTo(s) : s > t.slides.length - r ? (t.loopFix(), s = i.children("." + n.slideClass + '[data-swiper-slide-index="' + e + '"]:not(.' + n.slideDuplicateClass + ")").eq(0).index(), B.nextTick(function() {
                    t.slideTo(s)
                })) : t.slideTo(s)
            } else t.slideTo(s)
        }
    ...
    var h = {
        loopCreate: function() {
            ...
            for (var u = 0; u < l.length; u += 1) t.append(M(l[u].cloneNode(!0)).addClass(e.slideDuplicateClass));
    ...
    var f = {
            ...
            prependSlide: function(e) {
                ...
                n.loop && t.loopCreate(), n.observer && F.observer || t.update(), t.slideTo(s, 0, !1)
            },
            ...
            removeSlide: function(e) {
                ...
                n.loop && t.loopCreate(), n.observer && F.observer || t.update(), n.loop ? t.slideTo(a + t.loopedSlides, 0, !1) : t.slideTo(a, 0, !1)
            },
        ...
        v = function() {
            ...
            return t.pixelRatio = $.devicePixelRatio || 1, t
        }();
    ...
    var y = {
        attachEvents: function() {
            ...
            e.onTouchStart = function(e) {
                    ...
                    if (s.originalEvent && (s = s.originalEvent), n.isTouchEvent = "touchstart" === s.type, (n.isTouchEvent || !("which" in s) || 3 !== s.which) && !(!n.isTouchEvent && "button" in s && 0 < s.button || n.isTouched && n.isMoved))
                        ...
                        if (!l || !(a <= u || a >= $.screen.width - u)) {
                            if (B.extend(n, {
                                    ...
                                    isScrolling: void 0,
                                    startMoving: void 0
                                }), r.startX = a, r.startY = o, n.touchStartTime = B.now(), t.allowClick = !0, t.updateSize(), t.swipeDirection = void 0, 0 < i.threshold && (n.allowThresholdMove = !1), "touchstart" !== s.type) {
                                var c = !0;
                                M(s.target).is(n.formElements) && (c = !1), m.activeElement && M(m.activeElement).is(n.formElements) && m.activeElement !== s.target && m.activeElement.blur(), c && t.allowTouchMove && i.touchStartPreventDefault && s.preventDefault()
                            }
                            t.emit("touchStart", s)
                        }
                    }
                ...
                if (a.originalEvent && (a = a.originalEvent), n.isTouched) {
                    if (!n.isTouchEvent || "mousemove" !== a.type) {
                        ...
                        if (!t.allowTouchMove) return t.allowClick = !1, void(n.isTouched && (B.extend(r, {
                            startX: o,
                            startY: l,
                            currentX: o,
                            currentY: l
                        ...
                        if (n.isTouchEvent && m.activeElement && a.target === m.activeElement && M(a.target).is(n.formElements)) return n.isMoved = !0, void(t.allowClick = !1);
                ...
                if (t.allowClick && (t.updateClickedSlide(u), t.emit("tap", u), h < 300 && 300 < d - n.lastClickTime && (n.clickTimeout && clearTimeout(n.clickTimeout), n.clickTimeout = B.nextTick(function() {
                        t && !t.destroyed && t.emit("click", u)
                    }, 300)), h < 300 && d - n.lastClickTime < 300 && (n.clickTimeout && clearTimeout(n.clickTimeout), t.emit("doubleTap", u))), n.lastClickTime = B.now(), B.nextTick(function() {
                ...
                if (n.isTouched = !1, n.isMoved = !1, n.startMoving = !1, c = i.followFinger ? s ? t.translate : -t.translate : -n.currentTranslate, i.freeMode) {
                    ...
                    if (i.freeModeMomentum) {
                        if (1 < n.velocities.length) {
                            var p = n.velocities.pop(),
                                ...
                                v = p.time - f.time;
                            t.velocity = m / v, t.velocity /= 2, Math.abs(t.velocity) < i.freeModeMinimumVelocity && (t.velocity = 0), (150 < v || 300 < B.now() - p.time) && (t.velocity = 0)
                        } else t.velocity = 0;
                        ...
                        i.freeModeMomentumBounce && E ? (t.updateProgress(w), t.setTransition(g), t.setTranslate(b), t.transitionStart(!0, t.swipeDirection), t.animating = !0, a.transitionEnd(function() {
                    ...
                    for (var _ = 0, k = t.slidesSizesGrid[0], A = 0; A < o.length; A += i.slidesPerGroup) void 0 !== o[A + i.slidesPerGroup] ? c >= o[A] && c < o[A + i.slidesPerGroup] && (k = o[(_ = A) + i.slidesPerGroup] - o[A]) : c >= o[A] && (_ = A, k = o[o.length - 1] - o[o.length - 2]);
                    var D = (c - o[_]) / k;
                    if (h > i.longSwipesMs) {
            ...
            if (F.touch || !F.pointerEvents && !F.prefixedPointerEvents) {
                if (F.touch) {
                    var o = !("touchstart" !== n.start || !F.passiveListener || !t.passiveListeners) && {
                        passive: !0,
                        capture: !1
                    };
                    s.addEventListener(n.start, e.onTouchStart, o), s.addEventListener(n.move, e.onTouchMove, F.passiveListener ? {
                        passive: !1,
                        capture: a
                    } : a), s.addEventListener(n.end, e.onTouchEnd, o)
                }(t.simulateTouch && !v.ios && !v.android || t.simulateTouch && !F.touch && v.ios) && (s.addEventListener("mousedown", e.onTouchStart, !1), m.addEventListener("mousemove", e.onTouchMove, a), m.addEventListener("mouseup", e.onTouchEnd, !1))
        ...
        detachEvents: function() {
            ...
            if (F.touch || !F.pointerEvents && !F.prefixedPointerEvents) {
                if (F.touch) {
                    var o = !("onTouchStart" !== n.start || !F.passiveListener || !t.passiveListeners) && {
                        passive: !0,
                        capture: !1
                    };
                ...
                }(t.simulateTouch && !v.ios && !v.android || t.simulateTouch && !F.touch && v.ios) && (s.removeEventListener("mousedown", e.onTouchStart, !1), m.removeEventListener("mousemove", e.onTouchMove, a), m.removeEventListener("mouseup", e.onTouchEnd, !1))
    ...
    var b, w = {
            setBreakpoint: function() {
                ...
                if (s && (!s || 0 !== Object.keys(s).length)) {
                    ...
                    if (a && e.currentBreakpoint !== a) {
                        ...
                        B.extend(e.params, o), B.extend(e, {
                            allowTouchMove: e.params.allowTouchMove,
                            allowSlideNext: e.params.allowSlideNext,
                            allowSlidePrev: e.params.allowSlidePrev
                        }), e.currentBreakpoint = a, l && n && (e.loopDestroy(), e.loopCreate(), e.updateSlides(), e.slideTo(t - i + e.loopedSlides, 0, !1)), e.emit("breakpoint", o)
                    }
                }
            },
            getBreakpoint: function(e) {
                if (e) {
                    ...
                    for (var i = 0; i < n.length; i += 1) {
                        var r = n[i];
                        this.params.breakpointsInverse ? r <= $.innerWidth && (t = r) : r >= $.innerWidth && !t && (t = r)
                    }
                    return t || "max"
                }
            }
        ...
        I = {
            ...
            isSafari: (b = $.navigator.userAgent.toLowerCase(), 0 <= b.indexOf("safari") && b.indexOf("chrome") < 0 && b.indexOf("android") < 0),
    ...
    var x = {
        ...
        E = {
            ...
            classes: {
                addClasses: function() {
                    var t = this.classNames,
                        ...
                        i = this.$el,
                        r = [];
                    r.push(n.direction), n.freeMode && r.push("free-mode"), F.flexbox || r.push("no-flexbox"), n.autoHeight && r.push("autoheight"), e && r.push("rtl"), 1 < n.slidesPerColumn && r.push("multirow"), v.android && r.push("android"), v.ios && r.push("ios"), (I.isIE || I.isEdge) && (F.pointerEvents || F.prefixedPointerEvents) && r.push("wp8-" + n.direction), r.forEach(function(e) {
            ...
            images: {
                loadImage: function(e, t, n, i, r, s) {
                    ...
                    e.complete && r ? o() : t ? ((a = new $.Image).onload = o, a.onerror = o, i && (a.sizes = i), n && (a.srcset = n), t && (a.src = t)) : o()
                },
        ...
        S = function(h) {
            function p() {
                ...
                1 === n.length && n[0].constructor && n[0].constructor === Object ? r = n[0] : (t = (e = n)[0], r = e[1]), r || (r = {}), r = B.extend({}, r), t && !r.el && (r.el = t), h.call(this, r), Object.keys(E).forEach(function(t) {
                ...
                var a = B.extend({}, x);
                s.useModulesParams(a), s.params = B.extend({}, a, T, r), s.originalParams = B.extend({}, s.params), s.passedParams = B.extend({}, r);
                ...
                if (t = o[0]) {
                    ...
                    return B.extend(s, {
                        ...
                        touchEvents: (u = ["touchstart", "touchmove", "touchend"], c = ["mousedown", "mousemove", "mouseup"], F.pointerEvents ? c = ["pointerdown", "pointermove", "pointerup"] : F.prefixedPointerEvents && (c = ["MSPointerDown", "MSPointerMove", "MSPointerUp"]), s.touchEventsTouch = {
                            start: u[0],
                            move: u[1],
                            end: u[2]
            ...
            return ((p.prototype = Object.create(h && h.prototype)).constructor = p).prototype.slidesPerViewDynamic = function() {
                var e = this,
                    ...
                    a = 1;
                if (t.centeredSlides) {
                    for (var o, l = n[s].swiperSlideSize, u = s + 1; u < n.length; u += 1) n[u] && !o && (a += 1, r < (l += n[u].swiperSlideSize) && (o = !0));
                    for (var c = s - 1; 0 <= c; c -= 1) n[c] && !o && (a += 1, r < (l += n[c].swiperSlideSize) && (o = !0))
                } else
        ...
        A = {
            ...
            on: {
                init: function() {
                    $.addEventListener("resize", this.resize.resizeHandler), $.addEventListener("orientationchange", this.resize.orientationChangeHandler)
                },
                destroy: function() {
                    $.removeEventListener("resize", this.resize.resizeHandler), $.removeEventListener("orientationchange", this.resize.orientationChangeHandler)
                }
            }
        },
        D = {
        ...
        L = {
            update: function(e) {
                ...
                v = t.rtlTranslate ? "right" : t.isHorizontal() ? "left" : "top", s ? (g = Math.floor(i / 2) + r + o, y = Math.floor(i / 2) + r + l) : (g = i + (r - 1) + o, y = r + l);
                ...
                if (B.extend(t.virtual, {
                    ...
                    }), c === w && d === x && !e) return t.slidesGrid !== p && E !== m && t.slides.css(v, E + "px"), void t.updateProgress();
                ...
                for (var k = 0; k < h.length; k += 1) w <= k && k <= x && (void 0 === d || e ? C.push(k) : (d < k && C.push(k), k < c && S.push(k)));
            ...
            on: {
                beforeInit: function() {
                    ...
                    if (e.params.virtual.enabled) {
                        ...
                        B.extend(e.params, t), B.extend(e.originalParams, t), e.virtual.update()
                    }
                },
    ...
    var z = {
            ...
            event: -1 < $.navigator.userAgent.indexOf("firefox") ? "DOMMouseScroll" : function() {
                var e = "onwheel",
                    t = e in m;
                if (!t) {
            ...
            handle: function(e) {
                ...
                if (i.invert && (r = -r), n.params.freeMode) {
                    ...
                    var o = n.getTranslate() + r * i.sensitivity,
                        l = n.isBeginning,
                        u = n.isEnd;
                    if (o >= n.minTranslate() && (o = n.minTranslate()), o <= n.maxTranslate() && (o = n.maxTranslate()), n.setTransition(0), n.setTranslate(o), n.updateProgress(), n.updateActiveIndex(), n.updateSlidesClasses(), (!l && n.isBeginning || !u && n.isEnd) && n.updateSlidesClasses(), n.params.freeModeSticky && (clearTimeout(n.mousewheel.timeout), n.mousewheel.timeout = B.nextTick(function() {
                            n.slideToClosest()
                    ...
                    n.mousewheel.lastScrollTime = (new $.Date).getTime()
                }
        ...
        R = {
            ...
            updateSize: function() {
                ...
                if (e.params.scrollbar.el && e.scrollbar.el) {
                    ...
                    var r, s = e.isHorizontal() ? i[0].offsetWidth : i[0].offsetHeight,
                        ...
                        o = a * (s / e.size);
                    r = "auto" === e.params.scrollbar.dragSize ? s * a : parseInt(e.params.scrollbar.dragSize, 10), e.isHorizontal() ? n[0].style.width = r + "px" : n[0].style.height = r + "px", i[0].style.display = 1 <= a ? "none" : "", e.params.scrollbarHide && (i[0].style.opacity = 0), B.extend(t, {
                        trackSize: s,
                        divider: a,
                        moveDivider: o,
                        dragSize: r
            ...
            onDragStart: function(e) {
                var t = this,
                    ...
                    s = i.$el,
                    a = i.$dragEl;
                t.scrollbar.isTouched = !0, e.preventDefault(), e.stopPropagation(), r.transition(100), a.transition(100), i.setDragPosition(e), clearTimeout(t.scrollbar.dragTimeout), s.transition(0), n.hide && s.css("opacity", 1), t.emit("scrollbarDragStart", e)
            },
            ...
            onDragEnd: function(e) {
                var t = this,
                    n = t.params.scrollbar,
                    i = t.scrollbar.$el;
                t.scrollbar.isTouched && (t.scrollbar.isTouched = !1, n.hide && (clearTimeout(t.scrollbar.dragTimeout), t.scrollbar.dragTimeout = B.nextTick(function() {
            ...
            enableDraggable: function() {
                ...
                if (e.params.scrollbar.el) {
                    var t = e.scrollbar,
                        ...
                        r = e.params,
                        s = t.$el[0],
                        a = !(!F.passiveListener || !r.passiveListeners) && {
                            passive: !1,
                            capture: !1
                        },
                        o = !(!F.passiveListener || !r.passiveListeners) && {
                            passive: !0,
                            capture: !1
                        };
                    F.touch || !F.pointerEvents && !F.prefixedPointerEvents ? (F.touch && (s.addEventListener(n.start, e.scrollbar.onDragStart, a), s.addEventListener(n.move, e.scrollbar.onDragMove, a), s.addEventListener(n.end, e.scrollbar.onDragEnd, o)), (r.simulateTouch && !v.ios && !v.android || r.simulateTouch && !F.touch && v.ios) && (s.addEventListener("mousedown", e.scrollbar.onDragStart, a), m.addEventListener("mousemove", e.scrollbar.onDragMove, a), m.addEventListener("mouseup", e.scrollbar.onDragEnd, o))) : (s.addEventListener(i.start, e.scrollbar.onDragStart, a), m.addEventListener(i.move, e.scrollbar.onDragMove, a), m.addEventListener(i.end, e.scrollbar.onDragEnd, o))
                }
            },
            disableDraggable: function() {
                ...
                if (e.params.scrollbar.el) {
                    ...
                    F.touch || !F.pointerEvents && !F.prefixedPointerEvents ? (F.touch && (s.removeEventListener(n.start, e.scrollbar.onDragStart, a), s.removeEventListener(n.move, e.scrollbar.onDragMove, a), s.removeEventListener(n.end, e.scrollbar.onDragEnd, o)), (r.simulateTouch && !v.ios && !v.android || r.simulateTouch && !F.touch && v.ios) && (s.removeEventListener("mousedown", e.scrollbar.onDragStart, a), m.removeEventListener("mousemove", e.scrollbar.onDragMove, a), m.removeEventListener("mouseup", e.scrollbar.onDragEnd, o))) : (s.removeEventListener(i.start, e.scrollbar.onDragStart, a), m.removeEventListener(i.move, e.scrollbar.onDragMove, a), m.removeEventListener(i.end, e.scrollbar.onDragEnd, o))
                }
            },
            init: function() {
                var e = this;
                if (e.params.scrollbar.el) {
                    ...
                    0 === s.length && (s = M('<div class="' + e.params.scrollbar.dragClass + '"></div>'), r.append(s)), B.extend(t, {
                        $el: r,
                        el: r[0],
                        $dragEl: s,
                        dragEl: s[0]
        ...
        Y = {
            ...
            onGestureStart: function(e) {
                ...
                if (i.fakeGestureTouched = !1, i.fakeGestureMoved = !1, !F.gestures) {
                    ...
                    i.fakeGestureTouched = !0, r.scaleStart = Y.getDistanceBetweenTouches(e)
                }
            ...
            onGestureChange: function(e) {
                ...
                if (!F.gestures) {
                    ...
                    n.fakeGestureMoved = !0, i.scaleMove = Y.getDistanceBetweenTouches(e)
                }
            ...
            load: function() {
                ...
                if (a.loadPrevNext)
                    if (1 < o || a.loadPrevNextAmount && 1 < a.loadPrevNextAmount) {
                        for (var d = a.loadPrevNextAmount, h = o, p = Math.min(e + h + Math.max(d, h), r.length), f = Math.max(e - Math.max(h, d), 0), m = e + o; m < p; m += 1) l(m) && i.lazy.loadInSlide(m);
        ...
        U = {
            init: function() {
                var e = this;
                if (e.params.history) {
                    if (!$.history || !$.history.pushState) return e.params.history.enabled = !1, void(e.params.hashNavigation.enabled = !0);
                    var t = e.history;
                    t.initialized = !0, t.paths = U.getPathValues(), (t.paths.key || t.paths.value) && (t.scrollToSlide(0, t.paths.value, e.params.runCallbacksOnInit), e.params.history.replaceState || $.addEventListener("popstate", e.history.setHistoryPopState))
                }
            },
            destroy: function() {
                this.params.history.replaceState || $.removeEventListener("popstate", this.history.setHistoryPopState)
            },
            setHistoryPopState: function() {
                this.history.paths = U.getPathValues(), this.history.scrollToSlide(this.params.speed, this.history.paths.value, !1)
            },
            getPathValues: function() {
                var e = $.location.pathname.slice(1).split("/").filter(function(e) {
                        return "" !== e
                    }),
                    t = e.length;
                return {
            ...
            setHistory: function(e, t) {
                if (this.history.initialized && this.params.history.enabled) {
                    var n = this.slides.eq(t),
                        i = U.slugify(n.attr("data-history"));
            ...
            scrollToSlide: function(e, t, n) {
                ...
                if (t)
                    for (var r = 0, s = i.slides.length; r < s; r += 1) {
                        var a = i.slides.eq(r);
                        if (U.slugify(a.attr("data-history")) === t && !a.hasClass(i.params.slideDuplicateClass)) {
                            var o = a.index();
                            i.slideTo(o, e, n)
                        }
        ...
        Q = {
            ...
            setHash: function() {
                ...
                if (e.hashNavigation.initialized && e.params.hashNavigation.enabled)
                    if (e.params.hashNavigation.replaceState && $.history && $.history.replaceState) $.history.replaceState(null, null, "#" + e.slides.eq(e.activeIndex).attr("data-hash") || "");
                    else {
            ...
            init: function() {
                ...
                if (!(!e.params.hashNavigation.enabled || e.params.history && e.params.history.enabled)) {
                    ...
                    e.params.hashNavigation.watchState && M($).on("hashchange", e.hashNavigation.onHashCange)
                }
            },
            destroy: function() {
                this.params.hashNavigation.watchState && M($).off("hashchange", this.hashNavigation.onHashCange)
            }
        },
        K = {
            run: function() {
        ...
        J = {
            setTranslate: function() {
                var e, t = this,
                    ...
                    h = 0;
                u.shadow && (c ? (0 === (e = i.find(".swiper-cube-shadow")).length && (e = M('<div class="swiper-cube-shadow"></div>'), i.append(e)), e.css({
                    height: s + "px"
                ...
                for (var p = 0; p < r.length; p += 1) {
                    ...
                    var E = "rotateX(" + (c ? 0 : -v) + "deg) rotateY(" + (c ? v : 0) + "deg) translate3d(" + b + "px, " + w + "px, " + x + "px)";
                    if (y <= 1 && -1 < y && (h = 90 * m + 90 * y, o && (h = 90 * -m - 90 * y)), f.transform(E), u.slideShadows) {
                        ...
                        0 === T.length && (T = M('<div class="swiper-slide-shadow-' + (c ? "left" : "top") + '"></div>'), f.append(T)), 0 === S.length && (S = M('<div class="swiper-slide-shadow-' + (c ? "right" : "bottom") + '"></div>'), f.append(S)), T.length && (T[0].style.opacity = Math.max(-y, 0)), S.length && (S[0].style.opacity = Math.max(y, 0))
                    }
                }
                if (i.css({
                    ...
                    if (c) e.transform("translate3d(0px, " + (s / 2 + u.shadowOffset) + "px, " + -s / 2 + "px) rotateX(90deg) rotateZ(0deg) scale(" + u.shadowScale + ")");
                        ...
                        var C = Math.abs(h) - 90 * Math.floor(Math.abs(h) / 90),
                            ...
                            A = u.shadowScale / _,
                            D = u.shadowOffset;
                        e.transform("scale3d(" + k + ", 1, " + A + ") translate3d(0px, " + (a / 2 + D) + "px, " + -a / 2 / A + "px) rotateX(-90deg)")
            ...
            setTranslate: function() {
                for (var e = this, t = e.slides, n = e.rtlTranslate, i = 0; i < t.length; i += 1) {
                    ...
                    var a = -180 * s,
                        ...
                        u = 0;
                    if (e.isHorizontal() ? n && (a = -a) : (u = l, o = -a, a = l = 0), r[0].style.zIndex = -Math.abs(Math.round(s)) + t.length, e.params.flipEffect.slideShadows) {
                        ...
                        0 === c.length && (c = M('<div class="swiper-slide-shadow-' + (e.isHorizontal() ? "left" : "top") + '"></div>'), r.append(c)), 0 === d.length && (d = M('<div class="swiper-slide-shadow-' + (e.isHorizontal() ? "right" : "bottom") + '"></div>'), r.append(d)), c.length && (c[0].style.opacity = Math.max(-s, 0)), d.length && (d[0].style.opacity = Math.max(s, 0))
                    }
        ...
        te = {
            setTranslate: function() {
                for (var e = this, t = e.width, n = e.height, i = e.slides, r = e.$wrapperEl, s = e.slidesSizesGrid, a = e.params.coverflowEffect, o = e.isHorizontal(), l = e.translate, u = o ? t / 2 - l : n / 2 - l, c = o ? a.rotate : -a.rotate, d = a.depth, h = 0, p = i.length; h < p; h += 1) {
                    var f = i.eq(h),
                        m = s[h],
                        v = (u - f[0].swiperSlideOffset - m / 2) / m * a.modifier,
                        g = o ? c * v : 0,
                        y = o ? 0 : c * v,
                        b = -d * Math.abs(v),
                        w = o ? 0 : a.stretch * v,
                    ...
                    if (f.transform(E), f[0].style.zIndex = 1 - Math.abs(Math.round(v)), a.slideShadows) {
                        ...
                        0 === T.length && (T = M('<div class="swiper-slide-shadow-' + (o ? "left" : "top") + '"></div>'), f.append(T)), 0 === S.length && (S = M('<div class="swiper-slide-shadow-' + (o ? "right" : "bottom") + '"></div>'), f.append(S)), T.length && (T[0].style.opacity = 0 < v ? v : 0), S.length && (S[0].style.opacity = 0 < -v ? -v : 0)
                    }
                }(F.pointerEvents || F.prefixedPointerEvents) && (r[0].style.perspectiveOrigin = u + "px 50%")
            },
            setTransition: function(e) {
        ...
        ne = {
            ...
            onThumbClick: function() {
                ...
                if (t) {
                    ...
                    if (null != n) {
                        var i;
                        if (i = t.params.loop ? parseInt(M(t.clickedSlide).attr("data-swiper-slide-index"), 10) : n, e.params.loop) {
                            var r = e.activeIndex;
                            e.slides.eq(r).hasClass(e.params.slideDuplicateClass) && (e.loopFix(), e._clientLeft = e.$wrapperEl[0].clientLeft, r = e.activeIndex);
                            var s = e.slides.eq(r).prevAll('[data-swiper-slide-index="' + i + '"]').eq(0).index(),
                                a = e.slides.eq(r).nextAll('[data-swiper-slide-index="' + i + '"]').eq(0).index();
...
function(e, t) {
    ...
    function b(e) {
        ...
        var i = n && n.nodeName;
        return i && "BODY" !== i && "HTML" !== i ? -1 !== ["TD", "TABLE"].indexOf(n.nodeName) && "static" === w(n, "position") ? b(n) : n : e ? e.ownerDocument.documentElement : document.documentElement
    }
    ...
    function v(e, t) {
        ...
        if (e !== l && t !== l || i.contains(r)) return "BODY" === (o = (a = l).nodeName) || "HTML" !== o && b(a.firstElementChild) !== a ? b(l) : l;
        var u = c(e);
    ...
    function C(e, t) {
        ...
        return (i && !n ? t.contains(o) : t === o && "BODY" !== o.nodeName) && (d = function(e, t) {
            var n = 2 < arguments.length && void 0 !== arguments[2] && arguments[2],
                i = g(t, "top"),
                r = g(t, "left"),
                s = n ? -1 : 1;
    ...
    function k(e, t, n, i) {
        ...
        if ("viewport" === i) s = function(e) {
            ...
            var o = void 0;
            "scrollParent" === i ? "BODY" === (o = f(p(t))).nodeName && (o = e.ownerDocument.documentElement) : o = "window" === i ? e.ownerDocument.documentElement : i;
            var l = C(o, a, r);
    ...
    function I(e, t, n) {
        ...
        var i = O(e),
            ...
            l = s ? "height" : "width",
            u = s ? "width" : "height";
        return r[a] = t[a] + t[l] / 2 - i[l] / 2, r[o] = n === o ? t[o] - i[u] : t[M(o)], r
    }
    ...
    function H(e, t, n, i) {
        ...
        return function e(t, n, i, r) {
            ...
            a.addEventListener(n, i, {
                passive: !0
            }), s || e(f(a.parentNode), n, i, r), r.push(a)
    ...
    var G = {
            ...
            modifiers: {
                ...
                offset: {
                    ...
                    fn: function(e, t) {
                        var n = t.offset,
                            ...
                            o = i.split("-")[0],
                            l = void 0;
                        return l = R(+n) ? [+n, 0] : X(n, s, a, o), "left" === o ? (s.top += l[0], s.left -= l[1]) : "right" === o ? (s.top += l[0], s.left += l[1]) : "top" === o ? (s.left += l[0], s.top -= l[1]) : "bottom" === o && (s.left += l[0], s.top += l[1]), e.popper = s, e
                    },
                    offset: 0
                },
                preventOverflow: {
                    ...
                    fn: function(e, i) {
                        ...
                        var n = j("transform"),
                            ...
                            o = r[n];
                        r.top = "", r.left = "", r[n] = "";
                        var l = k(e.instance.popper, e.instance.reference, i.padding, t, e.positionFixed);
                        r.top = s, r.left = a, r[n] = o, i.boundaries = l;
                        var u = i.priority,
                            c = e.offsets.popper,
                            d = {
                                primary: function(e) {
                ...
                arrow: {
                    ...
                    fn: function(e, t) {
                        ...
                        var r = e.placement.split("-")[0],
                            ...
                            p = l ? "bottom" : "right",
                            f = O(i)[u];
                        o[p] - f < a[d] && (e.offsets.popper[d] -= a[d] - (o[p] - f)), o[d] + f > a[p] && (e.offsets.popper[d] += o[d] + f - a[p]), e.offsets.popper = T(e.offsets.popper);
                        var m = o[d] + o[u] / 2 - f / 2,
                            v = w(e.instance.popper),
                            g = parseFloat(v["margin" + c], 10),
                            y = parseFloat(v["border" + c + "Width"], 10),
                            b = m - e.offsets.popper[d] - g - y;
                        return b = Math.max(Math.min(a[u] - f, b), 0), e.arrowElement = i, e.offsets.arrow = (x(n = {}, d, Math.round(b)), x(n, h, ""), n), e
                    },
                    element: "[x-arrow]"
                },
                flip: {
                    ...
                    enabled: !0,
                    fn: function(f, m) {
                        if (N(f.instance.modifiers, "inner")) return f;
                        ...
                        return w.forEach(function(e, t) {
                            ...
                            var n, i = f.offsets.popper,
                                ...
                                s = Math.floor,
                                a = "left" === g && s(i.right) > s(r.left) || "right" === g && s(i.left) < s(r.right) || "top" === g && s(i.bottom) > s(r.top) || "bottom" === g && s(i.top) < s(r.bottom),
                                o = s(i.left) < s(v.left),
                                l = s(i.right) > s(v.right),
                                u = s(i.top) < s(v.top),
                                c = s(i.bottom) > s(v.bottom),
                                d = "left" === g && o || "right" === g && l || "top" === g && u || "bottom" === g && c,
                                h = -1 !== ["top", "bottom"].indexOf(g),
                                p = !!m.flipVariations && (h && "start" === b && o || h && "end" === b && l || !h && "start" === b && u || !h && "end" === b && c);
                            (a || d || p) && (f.flipped = !0, (a || d) && (g = w[t + 1]), p && (b = "end" === (n = b) ? "start" : "start" === n ? "end" : n), f.placement = g + (b ? "-" + b : ""), f.offsets.popper = E({}, f.offsets.popper, I(f.instance.popper, f.offsets.reference, f.placement)), f = P(f.instance.modifiers, f, "flip"))
                        }), f
                    },
                    behavior: "flip",
                    padding: 5,
                ...
                inner: {
                    ...
                    fn: function(e) {
                        ...
                        return r[a ? "left" : "top"] = s[n] - (o ? r[a ? "width" : "height"] : 0), e.placement = M(t), e.offsets.popper = T(r), e
                    }
                },
                hide: {
                    order: 800,
                ...
                computeStyle: {
                    ...
                    fn: function(e, t) {
                        ...
                        var a = void 0 !== s ? s : t.gpuAcceleration,
                            ...
                            f = void 0,
                            m = void 0;
                        if (m = "bottom" === d ? "HTML" === o.nodeName ? -o.clientHeight + c.bottom : -l.height + c.bottom : c.top, f = "right" === h ? "HTML" === o.nodeName ? -o.clientWidth + c.right : -l.width + c.right : c.left, a && p) u[p] = "translate3d(" + f + "px, " + m + "px, 0)", u[d] = 0, u[h] = 0, u.willChange = "transform";
                        else {
                            var v = "bottom" === d ? -1 : 1,
                                g = "right" === h ? -1 : 1;
                            u[d] = m * v, u[h] = f * g, u.willChange = d + ", " + h
                        }
                        var y = {
                ...
                applyStyle: {
                    ...
                    onLoad: function(e, t, n, i, r) {
                        var s = D(r, t, e, n.positionFixed),
                            a = A(n.placement, s, t, e, n.modifiers.flip.boundariesElement, n.modifiers.flip.padding);
        ...
        U = function() {
            function s(e, t) {
                ...
                u(this, s), this.scheduleUpdate = function() {
                    return requestAnimationFrame(n.update)
                }, this.update = a(this.update.bind(this)), this.options = E({}, s.Defaults, i), this.state = {
                    isDestroyed: !1,
                    isCreated: !1,
                    scrollParents: []
                }, this.reference = e && e.jquery ? e[0] : e, this.popper = t && t.jquery ? t[0] : t, this.options.modifiers = {}, Object.keys(E({}, s.Defaults.modifiers, i.modifiers)).forEach(function(e) {
                    n.options.modifiers[e] = E({}, s.Defaults.modifiers[e] || {}, i.modifiers ? i.modifiers[e] : {})
                ...
                value: function() {
                    return function() {
                        if (!this.state.isDestroyed) {
                            ...
                            e.offsets.reference = D(this.state, this.popper, this.reference, this.options.positionFixed), e.placement = A(this.options.placement, e.offsets.reference, this.popper, this.reference, this.options.modifiers.flip.boundariesElement, this.options.modifiers.flip.padding), e.originalPlacement = e.placement, e.positionFixed = this.options.positionFixed, e.offsets.popper = I(this.popper, e.offsets.reference, e.placement), e.offsets.popper.position = this.options.positionFixed ? "fixed" : "absolute", e = P(this.modifiers, e), this.state.isCreated ? this.options.onUpdate(e) : (this.state.isCreated = !0, this.options.onCreate(e))
                        }
                    }.call(this)
                }
            }, {
    ...
    return U.Utils = ("undefined" != typeof window ? window : global).PopperUtils, U.placements = F, U.Defaults = G, U
}),
function(e, t) {
    "use strict";
    ...
    var p = function(n) {
        var e, p, w, s, r, f, d, m, x, l, u, E, T, a, S, v, o, c, g, C = "sizzle" + 1 * new Date,
            y = n.document,
            _ = 0,
            i = 0,
            h = ae(),
            ...
            if (!i && ((t ? t.ownerDocument || t : y) !== T && E(t), t = t || T, S)) {
                if (11 !== h && (l = K.exec(e)))
                    if (r = l[1]) {
                        ...
                        } else if (d && (a = d.getElementById(r)) && g(t, a) && a.id === r) return n.push(a), n
                    } else {
                    ...
                    if (1 !== h) d = t, c = e;
                        ...
                        for ((o = t.getAttribute("id")) ? o = o.replace(te, ne) : t.setAttribute("id", o = C), s = (u = f(e)).length; s--;) u[s] = "#" + o + " " + ge(u[s]);
        ...
        for (e in p = se.support = {}, r = se.isXML = function(e) {
                ...
                return i !== T && 9 === i.nodeType && i.documentElement && (a = (T = i).documentElement, S = !r(T), y !== T && (n = T.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", ie, !1) : n.attachEvent && n.attachEvent("onunload", ie)), p.attributes = le(function(e) {
                ...
                }, o = [], v = [], (p.qsa = Q.test(T.querySelectorAll)) && (le(function(e) {
                ...
                }), v = v.length && new RegExp(v.join("|")), o = o.length && new RegExp(o.join("|")), t = Q.test(a.compareDocumentPosition), g = t || Q.test(a.contains) ? function(e, t) {
                    ...
                    return n || (1 & (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || !p.sortDetached && t.compareDocumentPosition(e) === n ? e === T || e.ownerDocument === y && g(y, e) ? -1 : t === T || t.ownerDocument === y && g(y, t) ? 1 : l ? P(l, e) - P(l, t) : 0 : 4 & n ? -1 : 1)
                } : function(e, t) {
                    if (e === t) return u = !0, 0;
                    var n, i = 0,
                        r = e.parentNode,
                        ...
                        a = [e],
                        o = [t];
                    if (!r || !s) return e === T ? -1 : t === T ? 1 : r ? -1 : s ? 1 : l ? P(l, e) - P(l, t) : 0;
                    if (r === s) return ce(e, t);
                    for (n = e; n = n.parentNode;) a.unshift(n);
                    for (n = t; n = n.parentNode;) o.unshift(n);
                    for (; a[i] === o[i];) i++;
                    return i ? ce(a[i], o[i]) : a[i] === y ? -1 : o[i] === y ? 1 : 0
                }), T
            }, se.matches = function(e, t) {
                return se(e, null, null, t)
            }, se.matchesSelector = function(e, t) {
                if ((e.ownerDocument || e) !== T && E(e), t = t.replace(W, "='$1']"), p.matchesSelector && S && !k[t + " "] && (!o || !o.test(t)) && (!v || !v.test(t))) try {
                    var n = c.call(e, t);
                ...
                filter: {
                    ...
                    CHILD: function(f, e, t, m, v) {
                        ...
                        return 1 === m && 0 === v ? function(e) {
                            ...
                            var i, r, s, a, o, l, u = g !== y ? "nextSibling" : "previousSibling",
                                c = e.parentNode,
                            ...
                            if (c) {
                                ...
                                if (l = [y ? c.firstChild : c.lastChild], y && h) {
                                    for (p = (o = (i = (r = (s = (a = c)[C] || (a[C] = {}))[a.uniqueID] || (s[a.uniqueID] = {}))[f] || [])[0] === _ && i[1]) && i[2], a = o && c.childNodes[o]; a = ++o && a && a[u] || (p = o = 0) || l.pop();)
                                        if (1 === a.nodeType && ++p && a === e) {
                                            r[f] = [_, o, p];
                                            break
                                        }
                                } else if (h && (p = o = (i = (r = (s = (a = e)[C] || (a[C] = {}))[a.uniqueID] || (s[a.uniqueID] = {}))[f] || [])[0] === _ && i[1]), !1 === p)
                                    for (;
                                        (a = ++o && a && a[u] || (p = o = 0) || l.pop()) && ((b ? a.nodeName.toLowerCase() !== d : 1 !== a.nodeType) || !++p || (h && ((r = (s = a[C] || (a[C] = {}))[a.uniqueID] || (s[a.uniqueID] = {}))[f] = [_, p]), a !== e)););
                    ...
                    PSEUDO: function(e, s) {
                        ...
                        return a[C] ? a(s) : 1 < a.length ? (t = [e, e, "", s], w.setFilters.hasOwnProperty(e.toLowerCase()) ? oe(function(e, t) {
                            for (var n, i = a(e, s), r = i.length; r--;) e[n = P(e, i[r])] = !(t[n] = i[r])
                        }) : function(e) {
                            return a(e, 0, t)
                        }) : a
                    }
                ...
                pseudos: {
                    ...
                    lang: oe(function(n) {
                        return V.test(n || "") || se.error("unsupported lang: " + n), n = n.replace(J, ee).toLowerCase(),
                            function(e) {
                                var t;
                                do {
                    ...
                    for (; e = e[l];)
                        if (1 === e.nodeType || d)
                            if (r = (s = e[C] || (e[C] = {}))[e.uniqueID] || (s[e.uniqueID] = {}), u && u === e.nodeName.toLowerCase()) e = e[l] || e;
                                ...
                                if ((i = r[c]) && i[0] === _ && i[1] === h) return a[2] = i[2];
        ...
        function xe(p, f, m, v, g, e) {
            return v && !v[C] && (v = xe(v)), g && !g[C] && (g = xe(g, e)), oe(function(e, t, n, i) {
                var r, s, a, o = [],
                    l = [],
                    u = t.length,
                    c = e || function(e, t, n) {
                    ...
                    d = !p || !e && f ? c : we(c, o, p, n, i),
                    h = m ? g || (e ? p : u || v) ? [] : t : d;
                if (m && m(d, h, n, i), v)
                    for (r = we(h, l), v(r, [], n, i), s = r.length; s--;)(a = r[s]) && (h[l[s]] = !(d[l[s]] = a));
                if (e) {
                    if (g || p) {
                        if (g) {
                        ...
                        for (s = h.length; s--;)(a = h[s]) && -1 < (r = g ? P(e, a) : o[s]) && (e[r] = !(t[r] = a))
                    }
                } else h = we(h === t ? h.splice(u, h.length) : h), g ? g(null, t, h, i) : I.apply(t, h)
            })
        }

        function Ee(e) {
            for (var r, t, n, i = e.length, s = w.relative[e[0].type], a = s || w.relative[" "], o = s ? 1 : 0, l = ye(function(e) {
                    return e === r
                }, a, !0), u = ye(function(e) {
                    return -1 < P(r, e)
                ...
                if (t = w.relative[e[o].type]) c = [ye(be(c), t)];
                    ...
                    if ((t = w.filter[e[o].type].apply(null, e[o].matches))[C]) {
                        ...
                        return xe(1 < o && be(c), 1 < o && ge(e.slice(0, o - 1).concat({
                            value: " " === e[o - 2].type ? "*" : ""
                        })).replace($, "$1"), t, o < n && Ee(e.slice(o, n)), n < i && Ee(e = e.slice(n)), n < i && ge(e))
                    }
                    c.push(t)
                } return be(c)
        }
        return ve.prototype = w.filters = w.pseudos, w.setFilters = new ve, f = se.tokenize = function(e, t) {
            var n, i, r, s, a, o, l, u = b[e + " "];
            if (u) return t ? 0 : u.slice(0);
            for (a = e, o = [], l = w.preFilter; a;) {
                for (s in n && !(i = B.exec(a)) || (i && (a = a.slice(i[0].length) || a), o.push(r = [])), n = !1, (i = F.exec(a)) && (n = i.shift(), r.push({
                        value: n,
                        type: i[0].replace($, " ")
                    }), a = a.slice(n.length)), w.filter) !(i = X[s].exec(a)) || l[s] && !(i = l[s](i)) || (n = i.shift(), r.push({
                    value: n,
                    type: s,
                    matches: i
                }), a = a.slice(n.length));
            ...
            return t ? a.length : a ? se.error(e) : b(e, o).slice(0)
        }, d = se.compile = function(e, t) {
            var n, v, g, y, b, i, r = [],
                s = [],
                a = k[e + " "];
            if (!a) {
                for (t || (t = f(e)), n = t.length; n--;)(a = Ee(t[n]))[C] ? r.push(a) : s.push(a);
                (a = k(e, (v = s, y = 0 < (g = r).length, b = 0 < v.length, i = function(e, t, n, i, r) {
                    var s, a, o, l = 0,
                        u = "0",
                        c = e && [],
                        d = [],
                    ...
                    for (r && (x = t === T || t || r); u !== m && null != (s = p[u]); u++) {
                        if (b && s) {
                            for (a = 0, t || s.ownerDocument === T || (E(s), n = !S); o = v[a++];)
                                if (o(s, t || T, n)) {
                                    i.push(s);
                                    break
                                } r && (_ = f)
                    ...
                    if (l += u, y && u !== l) {
                        for (a = 0; o = g[a++];) o(c, d, t, n);
                        if (e) {
                            if (0 < l)
                                for (; u--;) c[u] || d[u] || (d[u] = O.call(i));
                            d = we(d)
                        }
            ...
            if (n = n || [], 1 === c.length) {
                if (2 < (s = c[0] = c[0].slice(0)).length && "ID" === (a = s[0]).type && 9 === t.nodeType && S && w.relative[s[1].type]) {
                    if (!(t = (w.find.ID(a.matches[0].replace(J, ee), t) || [])[0])) return n;
                    u && (t = t.parentNode), e = e.slice(s.shift().value.length)
                }
                for (r = X.needsContext.test(e) ? 0 : s.length; r-- && (a = s[r], !w.relative[o = a.type]);)
                    if ((l = w.find[o]) && (i = l(a.matches[0].replace(J, ee), Z.test(s[0].type) && me(t.parentNode) || t))) {
                        if (s.splice(r, 1), !(e = i.length && ge(s))) return I.apply(n, i), n;
                        break
                    }
            }
            return (u || d(e, c))(i, t, !S, n, !t || Z.test(e) && me(t.parentNode) || t), n
        }, p.sortStable = C.split("").sort(A).join("") === C, p.detectDuplicates = !!u, E(), p.sortDetached = le(function(e) {
    ...
    C.Callbacks = function(i) {
        ...
        var r, t, s, a, o = [],
            ...
            c = function() {
                ...
                i.memory || (t = !1), r = !1, a && (o = t ? [] : "")
            },
            d = {
                add: function() {
                    return o && (t && !r && (u = o.length - 1, l.push(t)), function n(e) {
                        C.each(e, function(e, t) {
                            y(t) ? i.unique && d.has(t) || o.push(t) : t && t.length && "string" !== x(t) && n(t)
                        })
                    }(arguments), t && !r && c()), this
                },
                remove: function() {
                    return C.each(arguments, function(e, t) {
                        for (var n; - 1 < (n = C.inArray(t, o, n));) o.splice(n, 1), n <= u && u--
                    }), this
                },
                has: function(e) {
                ...
                a = {
                    ...
                    then: function(t, n, i) {
                                ...
                                var n = this,
                                    ...
                                    e = function() {
                                        ...
                                        if (!(r < l)) {
                                            ...
                                            t = e && ("object" == typeof e || "function" == typeof e) && e.then, y(t) ? o ? t.call(e, u(l, s, j, o), u(l, s, z, o)) : (l++, t.call(e, u(l, s, j, o), u(l, s, z, o), u(l, s, j, s.notifyWith))) : (a !== j && (n = void 0, i = [e]), (o || s.resolveWith)(n, i))
                                        }
                                    },
                                    t = o ? e : function() {
                                        try {
                                            ...
                                            C.Deferred.exceptionHook && C.Deferred.exceptionHook(e, t.stackTrace), l <= r + 1 && (a !== z && (n = void 0, i = [e]), s.rejectWith(n, i))
                                        }
                                    };
                        ...
                        return C.Deferred(function(e) {
                            s[0][3].add(u(0, e, y(i) ? i : j, e.notifyWith)), s[1][3].add(u(0, e, y(t) ? t : j)), s[2][3].add(u(0, e, y(n) ? n : z))
                        }).promise()
                    },
                    promise: function(e) {
        ...
        when: function(e) {
            ...
            if (n <= 1 && (H(e, s.done(a(t)).resolve, s.reject, !n), "pending" === s.state() || y(r[t] && r[t].then))) return s.then();
            for (; t--;) H(r[t], a(t), s.reject);
            return s.promise()
        }
    });
    ...
    var B = function(e, t, n, i, r, s, a) {
            var o = 0,
                l = e.length,
                u = null == n;
            if ("object" === x(n))
                for (o in r = !0, n) B(e, t, o, n[o], !0, s, a);
    ...
    function ge(e, t, n, i, r) {
        for (var s, a, o, l, u, c, d = t.createDocumentFragment(), h = [], p = 0, f = e.length; p < f; p++)
            ...
            for (a = a || d.appendChild(t.createElement("div")), o = (ue.exec(s) || ["", ""])[1].toLowerCase(), l = de[o] || de._default, a.innerHTML = l[1] + C.htmlPrefilter(s) + l[2], c = l[0]; c--;) a = a.lastChild;
            C.merge(h, a.childNodes), (a = d.firstChild).textContent = ""
        } else h.push(t.createTextNode(s));
        for (d.textContent = "", p = 0; s = h[p++];)
            if (i && -1 < C.inArray(s, i)) r && r.push(s);
            else if (u = C.contains(s.ownerDocument, s), a = he(d.appendChild(s), "script"), u && pe(a), n)
    ...
    C.event = {
        ...
        add: function(t, e, n, i, r) {
            var s, a, o, l, u, c, d, h, p, f, m, v = U.get(t);
            if (v)
                for (n.handler && (n = (s = n).handler, r = s.selector), r && C.find.matchesSelector(ye, r), n.guid || (n.guid = C.guid++), (l = v.events) || (l = v.events = {}), (a = v.handle) || (a = v.handle = function(e) {
                        return void 0 !== C && C.event.triggered !== e.type ? C.event.dispatch.apply(t, arguments) : void 0
                    }), u = (e = (e || "").match(N) || [""]).length; u--;) p = m = (o = xe.exec(e[u]) || [])[1], f = (o[2] || "").split(".").sort(), p && (d = C.event.special[p] || {}, p = (r ? d.delegateType : d.bindType) || p, d = C.event.special[p] || {}, c = C.extend({
                    type: p,
                    origType: m,
                    data: i,
                    handler: n,
                    ...
                    namespace: f.join(".")
                }, s), (h = l[p]) || ((h = l[p] = []).delegateCount = 0, d.setup && !1 !== d.setup.call(t, i, f, a) || t.addEventListener && t.addEventListener(p, a)), d.add && (d.add.call(t, c), c.handler.guid || (c.handler.guid = n.guid)), r ? h.splice(h.delegateCount++, 0, c) : h.push(c), C.event.global[p] = !0)
        },
        remove: function(e, t, n, i, r) {
            var s, a, o, l, u, c, d, h, p, f, m, v = U.hasData(e) && U.get(e);
            if (v && (l = v.events)) {
                for (u = (t = (t || "").match(N) || [""]).length; u--;)
                    if (p = m = (o = xe.exec(t[u]) || [])[1], f = (o[2] || "").split(".").sort(), p) {
                        for (d = C.event.special[p] || {}, h = l[p = (i ? d.delegateType : d.bindType) || p] || [], o = o[2] && new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)"), a = s = h.length; s--;) c = h[s], !r && m !== c.origType || n && n.guid !== c.guid || o && !o.test(c.namespace) || i && i !== c.selector && ("**" !== i || !c.selector) || (h.splice(s, 1), c.selector && h.delegateCount--, d.remove && d.remove.call(e, c));
    ...
    function Le(e, t) {
        var n, i, r, s, a, o, l, u;
        if (1 === t.nodeType) {
            if (U.hasData(e) && (s = U.access(e), a = U.set(t, s), u = s.events))
    ...
    function Pe(n, i, r, s) {
        ...
        if (f || 1 < d && "string" == typeof p && !g.checkClone && Ae.test(p)) return n.each(function(e) {
            var t = n.eq(e);
            f && (i[0] = p.call(this, e, t.html())), Pe(t, i, r, s)
        });
        if (d && (t = (e = ge(i, n[0].ownerDocument, !1, n, s)).firstChild, 1 === e.childNodes.length && (e = t), t || s)) {
            for (o = (a = C.map(he(e, "script"), Me)).length; c < d; c++) l = e, c !== h && (l = C.clone(l, !0, !0), o && C.merge(a, he(l, "script"))), r.call(n[c], l, c);
            if (o)
                for (u = a[a.length - 1].ownerDocument, C.map(a, Ie), c = 0; c < o; c++) l = a[c], ce.test(l.type || "") && !U.access(l, "globalEval") && C.contains(u, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? C._evalUrl && C._evalUrl(l.src) : w(l.textContent.replace(De, ""), u, l))
        }
        return n
    }
    ...
    C.extend({
        ...
        clone: function(e, t, n) {
            ...
            if (t)
                if (n)
                    for (s = s || he(e), a = a || he(c), i = 0, r = s.length; i < r; i++) Le(s[i], a[i]);
                else Le(e, c);
        ...
        html: function(e) {
            return B(this, function(e) {
                ...
                if ("string" == typeof e && !ke.test(e) && !de[(ue.exec(e) || ["", ""])[1].toLowerCase()]) {
                    e = C.htmlPrefilter(e);
                    try {
    ...
    function qe(e, t, n) {
        ...
        return (n = n || ze(e)) && ("" !== (a = n.getPropertyValue(t) || n[t]) || C.contains(e.ownerDocument, e) || (a = C.style(e, t)), !g.pixelBoxStyles() && je.test(a) && He.test(t) && (i = o.width, r = o.minWidth, s = o.maxWidth, o.minWidth = o.maxWidth = o.width = a, a = n.width, o.width = i, o.minWidth = r, o.maxWidth = s)), void 0 !== a ? a + "" : a
    }
    ...
    function Re(e, t) {
        ...
        function e() {
            if (l) {
                ...
                n = "1%" !== e.top, a = 12 === t(e.marginLeft), l.style.right = "60%", s = 36 === t(e.right), i = 36 === t(e.width), l.style.position = "absolute", r = 36 === l.offsetWidth || "absolute", ye.removeChild(o), l = null
            }
        }
        ...
        var n, i, r, s, a, o = S.createElement("div"),
    ...
    function Qe(e, t, n) {
        ...
        return a = a && (g.boxSizingReliable() || r === e.style[t]), ("auto" === r || !parseFloat(r) && "inline" === C.css(e, "display", !1, i)) && (r = e["offset" + t[0].toUpperCase() + t.slice(1)], a = !0), (r = parseFloat(r) || 0) + Ue(e, t, n || (s ? "border" : "content"), a, i, r) + "px"
    }
        ...
        style: function(e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var r, s, a, o = V(t),
                    l = Be.test(t),
                    u = e.style;
                if (l || (t = Xe(o)), a = C.cssHooks[t] || C.cssHooks[o], void 0 === n) return a && "get" in a && void 0 !== (r = a.get(e, !1, i)) ? r : u[t];
                "string" === (s = typeof n) && (r = te.exec(n)) && r[1] && (n = se(e, t, r), s = "number"), null != n && n == n && ("number" === s && (n += r && r[3] || (C.cssNumber[o] ? "" : "px")), g.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (u[t] = "inherit"), a && "set" in a && void 0 === (n = a.set(e, n, i)) || (l ? u.setProperty(t, n) : u[t] = n))
            }
        },
        css: function(e, t, n, i) {
            var r, s, a, o = V(t);
            return Be.test(t) || (t = Xe(o)), (a = C.cssHooks[t] || C.cssHooks[o]) && "get" in a && (r = a.get(e, !0, n)), void 0 === r && (r = qe(e, t, i)), "normal" === r && t in We && (r = We[t]), "" === n || n ? (s = parseFloat(r), !0 === n || isFinite(s) ? s || 0 : r) : r
        }
    }), C.each(["height", "width"], function(e, o) {
        C.cssHooks[o] = {
            get: function(e, t, n) {
                if (t) return !$e.test(C.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? Qe(e, o, n) : re(e, Fe, function() {
                    return Qe(e, o, n)
                })
            },
            set: function(e, t, n) {
                var i, r = ze(e),
                    ...
                    a = n && Ue(e, o, n, s, r);
                return s && g.scrollboxSize() === r.position && (a -= Math.ceil(e["offset" + o[0].toUpperCase() + o.slice(1)] - parseFloat(r[o]) - Ue(e, o, "border", !1, r) - .5)), a && (i = te.exec(t)) && "px" !== (i[3] || "px") && (e.style[o] = t, t = C.css(e, o)), Ge(0, t, a)
            }
        }
        ...
        css: function(e, t) {
            return B(this, function(e, t, n) {
                var i, r, s = {},
                    a = 0;
                if (Array.isArray(t)) {
                    for (i = ze(e), r = t.length; a < r; a++) s[t[a]] = C.css(e, t[a], !1, i);
                    return s
                }
    ...
    function lt(s, e, t) {
        ...
        for (! function(e, t) {
                var n, i, r, s, a;
                for (n in e)
                    if (r = t[i = V(n)], s = e[n], Array.isArray(s) && (r = s[1], s = e[n] = s[0]), n !== i && (e[i] = s, delete e[n]), (a = C.cssHooks[i]) && "expand" in a)
                        for (n in s = a.expand(s), delete e[i], s) n in e || (e[n] = s[n], t[n] = r);
                    else t[i] = r
            }(c, u.opts.specialEasing); i < r; i++)
            if (n = lt.prefilters[i].call(u, s, c, u.opts)) return y(n.stop) && (C._queueHooks(u.elem, u.opts.queue).stop = n.stop.bind(n)), n;
    ...
    C.Animation = C.extend(lt, {
        ...
        prefilters: [function(e, t, n) {
            ...
            for (i in n.queue || (null == (a = C._queueHooks(e, "fx")).unqueued && (a.unqueued = 0, o = a.empty.fire, a.empty.fire = function() {
                ...
                for (i in d && 1 === e.nodeType && (n.overflow = [f.overflow, f.overflowX, f.overflowY], null == (u = v && v.display) && (u = U.get(e, "display")), "none" === (c = C.css(e, "display")) && (u ? c = u : (oe([e], !0), u = e.style.display || u, c = C.css(e, "display"), oe([e]))), ("inline" === c || "inline-block" === c && null != u) && "none" === C.css(e, "float") && (l || (h.done(function() {
                        f.display = u
                    ...
                    for (i in m || oe([e]), U.remove(e, "fxshow"), p) C.style(e, i, p[i])
                })), l = ot(m ? v[i] : 0, i, h), i in v || (v[i] = l.start, m && (l.end = l.start, l.start = 0))
        }],
    ...
    C.extend(C.event, {
        trigger: function(e, t, n, i) {
            ...
            if (s = d = a = n = n || S, 3 !== n.nodeType && 8 !== n.nodeType && !gt.test(p + C.event.triggered) && (-1 < p.indexOf(".") && (p = (f = p.split(".")).shift(), f.sort()), l = p.indexOf(":") < 0 && "on" + p, (e = e[C.expando] ? e : new C.Event(p, "object" == typeof e && e)).isTrigger = i ? 2 : 3, e.namespace = f.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = n), t = null == t ? [e] : C.makeArray(t, [e]), c = C.event.special[p] || {}, i || !c.trigger || !1 !== c.trigger.apply(n, t))) {
                if (!i && !c.noBubble && !b(n)) {
                ...
                for (r = 0;
                    (s = h[r++]) && !e.isPropagationStopped();) d = s, e.type = 1 < r ? o : c.bindType || p, (u = (U.get(s, "events") || {})[e.type] && U.get(s, "handle")) && u.apply(s, t), (u = l && s[l]) && u.apply && X(s) && (e.result = u.apply(s, t), !1 === e.result && e.preventDefault());
                return e.type = p, i || e.isDefaultPrevented() || c._default && !1 !== c._default.apply(h.pop(), t) || !X(n) || l && y(n[p]) && !b(n) && ((a = n[l]) && (n[l] = null), C.event.triggered = p, e.isPropagationStopped() && d.addEventListener(p, yt), n[p](), e.isPropagationStopped() && d.removeEventListener(p, yt), C.event.triggered = void 0, a && (n[l] = a)), e.result
            }
        },
    ...
    jt.href = bt.href, C.extend({
        ...
        ajax: function(e, t) {
            ...
            var c, d, h, n, p, i, f, m, r, s, v = C.ajaxSetup({}, t),
                g = v.context || v,
            ...
            if (v.data && v.processData && "string" != typeof v.data && (v.data = C.param(v.data, v.traditional)), Ht(Lt, v, t, E), f) return E;
            ...
            if (l = "abort", w.add(v.complete), E.done(v.success), E.fail(v.error), c = Ht(Pt, v, t, E)) {
            ...
            function u(e, t, n, i) {
                var r, s, a, o, l, u = t;
                f || (f = !0, p && T.clearTimeout(p), c = void 0, h = i || "", E.readyState = 0 < e ? 4 : 0, r = 200 <= e && e < 300 || 304 === e, n && (o = function(e, t, n) {
                ...
                }(v, o, E, r), r ? (v.ifModified && ((l = E.getResponseHeader("Last-Modified")) && (C.lastModified[d] = l), (l = E.getResponseHeader("etag")) && (C.etag[d] = l)), 204 === e || "HEAD" === v.type ? u = "nocontent" : 304 === e ? u = "notmodified" : (u = o.state, s = o.data, r = !(a = o.error))) : (a = u, !e && u || (u = "error", e < 0 && (e = 0))), E.status = e, E.statusText = (t || u) + "", r ? b.resolveWith(g, [s, u, E]) : b.rejectWith(g, [E, u, a]), E.statusCode(x), x = void 0, m && y.trigger(r ? "ajaxSuccess" : "ajaxError", [E, v, r ? s : a]), w.fireWith(g, [E, u]), m && (y.trigger("ajaxComplete", [E, v]), --C.active || C.event.trigger("ajaxStop")))
            }
            return E
        },
    ...
    g.cors = !!$t && "withCredentials" in $t, g.ajax = $t = !!$t, C.ajaxTransport(function(r) {
        ...
        if (g.cors || $t && !r.crossDomain) return {
            send: function(e, t) {
                ...
                s = function(e) {
                    return function() {
                        s && (s = a = i.onload = i.onerror = i.onabort = i.ontimeout = i.onreadystatechange = null, "abort" === e ? i.abort() : "error" === e ? "number" != typeof i.status ? t(0, "error") : t(i.status, i.statusText) : t(Rt[i.status] || i.status, i.statusText, "text" !== (i.responseType || "text") || "string" != typeof i.responseText ? {
                            binary: i.response
                        } : {
                            text: i.responseText
    ...
    C.ajaxSetup({
        ...
        var i, r, s, a = !1 !== e.jsonp && (Wt.test(e.url) ? "url" : "string" == typeof e.data && 0 === (e.contentType || "").indexOf("application/x-www-form-urlencoded") && Wt.test(e.data) && "data");
        if (a || "jsonp" === e.dataTypes[0]) return i = e.jsonpCallback = y(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, a ? e[a] = e[a].replace(Wt, "$1" + i) : !1 !== e.jsonp && (e.url += (xt.test(e.url) ? "&" : "?") + e.jsonp + "=" + i), e.converters["script json"] = function() {
        ...
        var i, r, s, a = this,
            o = e.indexOf(" ");
        return -1 < o && (i = pt(e.slice(o)), e = e.slice(0, o)), y(t) ? (n = t, t = void 0) : t && "object" == typeof t && (r = "POST"), 0 < a.length && C.ajax({
            url: e,
            type: r || "GET",
            dataType: "html",
            data: t
        ...
        setOffset: function(e, t, n) {
            var i, r, s, a, o, l, u = C.css(e, "position"),
                c = C(e),
                d = {};
            "static" === u && (e.style.position = "relative"), o = c.offset(), s = C.css(e, "top"), l = C.css(e, "left"), ("absolute" === u || "fixed" === u) && -1 < (s + l).indexOf("auto") ? (a = (i = c.position()).top, r = i.left) : (a = parseFloat(s) || 0, r = parseFloat(l) || 0), y(t) && (t = t.call(e, n, C.extend({}, o))), null != t.top && (d.top = t.top - o.top + a), null != t.left && (d.left = t.left - o.left + r), "using" in t ? t.using.call(e, d) : c.css(d)
        }
    }, C.fn.extend({
        offset: function(t) {
        ...
        C.each({
            ...
            C.fn[s] = function(e, t) {
                ...
                return B(this, function(e, t, n) {
                    var i;
                    return b(e) ? 0 === s.indexOf("outer") ? e["inner" + a] : e.document.documentElement["client" + a] : 9 === e.nodeType ? (i = e.documentElement, Math.max(e.body["scroll" + a], i["scroll" + a], e.body["offset" + a], i["offset" + a], i["client" + a])) : void 0 === n ? C.css(e, t, r) : C.style(e, t, n, r)
                }, o, n ? e : void 0, n)
            }
        })
    ...
    }, C.isArray = Array.isArray, C.parseJSON = JSON.parse, C.nodeName = k, C.isFunction = y, C.isWindow = b, C.camelCase = V, C.type = x, C.now = Date.now, C.isNumeric = function(e) {
        var t = C.type(e);
    ...
    return C.noConflict = function(e) {
        return T.$ === C && (T.$ = Vt), e && T.jQuery === C && (T.jQuery = Yt), C
    }, e || (T.jQuery = T.$ = C), C
        ...
        easeInElastic: function(e, t, n, i, r) {
            ...
            return -o * Math.pow(2, 10 * (t -= 1)) * Math.sin(2 * (t * r - s) * Math.PI / a) + n
        },
        easeOutElastic: function(e, t, n, i, r) {
            ...
            return o * Math.pow(2, -10 * t) * Math.sin(2 * (t * r - s) * Math.PI / a) + i + n
        },
        easeInOutElastic: function(e, t, n, i, r) {
            ...
            return t < 1 ? -.5 * o * Math.pow(2, 10 * (t -= 1)) * Math.sin(2 * (t * r - s) * Math.PI / a) + n : o * Math.pow(2, -10 * (t -= 1)) * Math.sin(2 * (t * r - s) * Math.PI / a) * .5 + i + n
        },
    ...
    function(e) {
        ...
        c.extend(c.fn, {
            ...
            rules: function(e, t) {
                var n, i, r, s, a, o, l = this[0];
                if (null != l && (!l.form && l.isContentEditable && (l.form = this.closest("form")[0], l.name = this.attr("name")), null != l.form)) {
            ...
            prototype: {
                init: function() {
                    ...
                    function e(e) {
                        if (!this.form && this.isContentEditable && (this.form = c(this).closest("form")[0], this.name = c(this).attr("name")), r === this.form) {
                ...
                element: function(e) {
                    ...
                    return void 0 === r ? delete this.invalid[i.name] : (this.prepareElement(r), this.currentElements = c(r), (n = this.groups[r.name]) && c.each(this.groups, function(e, t) {
                        t === n && e !== r.name && (i = s.validationTargetFor(s.clean(s.findByName(e)))) && i.name in s.invalid && (s.currentElements.push(i), a = s.check(i) && a)
                ...
                elements: function() {
                    ...
                    return c(this.currentForm).find("input, select, textarea, [contenteditable]").not(":submit, :reset, :image, :disabled").not(this.settings.ignore).filter(function() {
                        ...
                        return !e && t.settings.debug && window.console && console.error("%o has no name assigned", this), this.isContentEditable && (this.form = c(this).closest("form")[0], this.name = e), this.form === t.currentForm && (!(e in n || !t.objectLength(c(this).rules())) && (n[e] = !0))
                    })
                },
                clean: function(e) {
                    return c(e)[0]
                ...
                elementValue: function(e) {
                    var t, n, i = c(e),
                        r = e.type;
                    return "radio" === r || "checkbox" === r ? this.findByName(e.name).filter(":checked").val() : "number" === r && void 0 !== e.validity ? e.validity.badInput ? "NaN" : i.val() : (t = e.isContentEditable ? i.text() : i.val(), "file" === r ? "C:\\fakepath\\" === t.substr(0, 12) ? t.substr(12) : 0 <= (n = t.lastIndexOf("/")) ? t.substr(n + 1) : 0 <= (n = t.lastIndexOf("\\")) ? t.substr(n + 1) : t : "string" == typeof t ? t.replace(/\r/g, "") : t)
                },
                check: function(t) {
                    ...
                    for (n in "function" == typeof s.normalizer ? r = s.normalizer : "function" == typeof this.settings.normalizer && (r = this.settings.normalizer), r && (l = r.call(t, l), delete s.normalizer), s) {
                        ...
                        try {
                            if ("dependency-mismatch" === (e = c.validator.methods[n].call(this, l, t, i.parameters)) && 1 === a) {
                                o = !0;
                                continue
                            }
                ...
                showLabel: function(e, t) {
                    var n, i, r, s, a = this.errorsFor(e),
                        o = this.idOrName(e),
                        l = c(e).attr("aria-describedby");
                    a.length ? (a.removeClass(this.settings.validClass).addClass(this.settings.errorClass), a.html(t)) : (n = a = c("<" + this.settings.errorElement + ">").attr("id", o + "-error").addClass(this.settings.errorClass).html(t || ""), this.settings.wrapper && (n = a.hide().show().wrap("<" + this.settings.wrapper + "/>").parent()), this.labelContainer.length ? this.labelContainer.append(n) : this.settings.errorPlacement ? this.settings.errorPlacement.call(this, n, c(e)) : n.insertAfter(e), a.is("label") ? a.attr("for", o) : 0 === a.parents("label[for='" + this.escapeCssMeta(o) + "']").length && (r = a.attr("id"), l ? l.match(new RegExp("\\b" + this.escapeCssMeta(r) + "\\b")) || (l += " " + r) : l = r, c(e).attr("aria-describedby", l), (i = this.groups[e.name]) && (s = this, c.each(s.groups, function(e, t) {
                        t === i && c("[name='" + s.escapeCssMeta(e) + "']", s.currentForm).attr("aria-describedby", a.attr("id"))
            ...
            attributeRules: function(e) {
                ...
                for (t in c.validator.methods) "required" === t ? ("" === (n = e.getAttribute(t)) && (n = !0), n = !!n) : n = r.attr(t), this.normalizeAttributeRule(i, s, t, n);
            ...
            methods: {
                ...
                step: function(e, t, n) {
                    ...
                    return i = o(n), (o(e) > i || l(e) % l(n) != 0) && (u = !1), this.optional(t) || u
                },
                ...
                remote: function(s, a, e, o) {
                    ...
                    var l, t, n, u = this.previousValue(a, o);
                    return this.settings.messages[a.name] || (this.settings.messages[a.name] = {}), u.originalMessage = u.originalMessage || this.settings.messages[a.name][o], this.settings.messages[a.name][o] = u.message, e = "string" == typeof e && {
                        ...
                        data: s
                    }, e.data)), u.old === n ? u.valid : (u.old = n, (l = this).startRequest(a), (t = {})[a.name] = s, c.ajax(c.extend(!0, {
                        mode: "abort",
                        ...
                        success: function(e) {
                            ...
                            l.settings.messages[a.name][o] = u.originalMessage, r ? (i = l.formSubmitted, l.resetInternals(), l.toHide = l.errorsFor(a), l.formSubmitted = i, l.successList.push(a), l.invalid[a.name] = !1, l.showErrors()) : (t = {}, n = e || l.defaultMessage(a, {
                                method: o,
                                parameters: s
                            }), t[a.name] = u.message = n, l.invalid[a.name] = !0, l.showErrors(t)), u.valid = r, l.stopRequest(a, r)
                        }
                    }, e)), "pending")
                }
            }
    ...
    function(e, t) {
        ...
        var r, n, s, o, u, d, h, p, f, m, v, g, y, b, w, x, E, T, S, C, _, k, A, D, O, M, I, L, P, N, j, z, H, q, R, $, B, F, W, Y, V, X, G, U, Q, K, Z, J, ee, te, ne, ie, re, se, ae, oe, le, ue, ce, de, he, pe, fe, me, ve, ge, ye, be, we, xe, Ee, Te, Se, Ce, _e, ke, Ae, De, Oe, Me, Ie, Le, Pe, Ne, je, ze, He, qe, Re, $e, Be, Fe, We, Ye, Ve, Xe, Ge, Ue, Qe, Ke, Ze, Je, et, tt, nt, it, rt, st, at, ot, lt, ut, ct, dt, ht, pt, ft, mt, vt, gt, yt, bt, wt, xt, Et, Tt, St, Ct, _t, kt, At, Dt, Ot, Mt, It, Lt, Pt, Nt, jt, zt, Ht, qt, Rt, $t, Bt, Ft, Wt, Yt, Vt, Xt, Gt, Ut, Qt, Kt, Zt, Jt, en, tn, nn, rn, sn, an, on, ln, un, cn, dn, hn, pn, fn, mn, vn, gn, yn, bn, wn, xn = function(i) {
                var t = "transitionend";
                    ...
                    typeCheckConfig: function(e, t, n) {
                        for (var i in n)
                            if (Object.prototype.hasOwnProperty.call(n, i)) {
                                var r = n[i],
                                    s = t[i],
                                    a = s && l.isElement(s) ? "element" : (o = s, {}.toString.call(o).match(/\s([a-z]+)/i)[1].toLowerCase());
            ...
            En = (n = "alert", o = "." + (s = "bs.alert"), u = (r = t).fn[n], d = {
                CLOSE: "close" + o,
                CLOSED: "closed" + o,
                ...
                return e.close = function(e) {
                    ...
                    var t = xn.getSelectorFromElement(e),
                        n = !1;
                    return t && (n = document.querySelector(t)), n || (n = r(e).closest("." + h)[0]), n
                    ...
                    if (r(t).removeClass(f), r(t).hasClass(p)) {
                        var e = xn.getTransitionDurationFromElement(t);
                        r(t).one(xn.TRANSITION_END, function(e) {
            ...
            }(), r(document).on(d.CLICK_DATA_API, '[data-dismiss="alert"]', m._handleDismiss(new m)), r.fn[n] = m._jQueryInterface, r.fn[n].Constructor = m, r.fn[n].noConflict = function() {
                return r.fn[n] = u, m._jQueryInterface
            }, m),
            Tn = (g = "button", b = "." + (y = "bs.button"), w = ".data-api", x = (v = t).fn[g], E = "active", T = "btn", C = '[data-toggle^="button"]', _ = '[data-toggle="buttons"]', k = "input", A = ".active", D = ".btn", O = {
                    ...
                    if (n) {
                        ...
                        if (i) {
                            if ("radio" === i.type)
                                ...
                                i.checked = !this._element.classList.contains(E), v(i).trigger("change")
                            }
                            i.focus(), t = !1
                        }
                    }
                    t && this._element.setAttribute("aria-pressed", !this._element.classList.contains(E)), e && v(this._element).toggleClass(E)
                }, e.dispose = function() {
                    v.removeData(this._element, y), this._element = null
                }, n._jQueryInterface = function(t) {
                    return this.each(function() {
                        var e = v(this).data(y);
                        e || (e = new n(this), v(this).data(y, e)), "toggle" === t && e[t]()
                    })
                }, a(n, null, [{
                    key: "VERSION",
                    get: function() {
            ...
            }(), v(document).on(O.CLICK_DATA_API, C, function(e) {
                e.preventDefault();
                var t = e.target;
            ...
            Sn = (L = "carousel", N = "." + (P = "bs.carousel"), j = (I = t).fn[L], z = {
            ...
            }, W = "carousel", Y = "active", V = "slide", X = "carousel-item-right", G = "carousel-item-left", U = "carousel-item-next", Q = "carousel-item-prev", K = {
                ACTIVE: ".active",
                ...
                function s(e, t) {
                    this._items = null, this._interval = null, this._activeElement = null, this._isPaused = !1, this._isSliding = !1, this.touchTimeout = null, this._config = this._getConfig(t), this._element = I(e)[0], this._indicatorsElement = this._element.querySelector(K.INDICATORS), this._addEventListeners()
                }
                var e = s.prototype;
                return e.next = function() {
                    ...
                    e || (this._isPaused = !0), this._element.querySelector(K.NEXT_PREV) && (xn.triggerTransitionEnd(this._element), this.cycle(!0)), clearInterval(this._interval), this._interval = null
                }, e.cycle = function(e) {
                    ...
                    return e = l({}, z, e), xn.typeCheckConfig(L, e, H), e
                }, e._addEventListeners = function() {
                    var t = this;
                    this._config.keyboard && I(this._element).on(F.KEYDOWN, function(e) {
                        return t._keydown(e)
                    }), "hover" === this._config.pause && (I(this._element).on(F.MOUSEENTER, function(e) {
                        return t.pause(e)
                    ...
                    var a = (r + (e === R ? -1 : 1)) % this._items.length;
                    ...
                    if (this._indicatorsElement) {
                        var t = [].slice.call(this._indicatorsElement.querySelectorAll(K.ACTIVE));
                        I(t).removeClass(Y);
                    ...
                    if (e === q ? (n = G, i = U, r = $) : (n = X, i = Q, r = B), l && I(l).hasClass(Y)) this._isSliding = !1;
                    else if (!this._triggerSlideEvent(l, r).isDefaultPrevented() && a && l) {
                        this._isSliding = !0, c && this.pause(), this._setActiveIndicatorElement(l);
                        var d = I.Event(F.SLID, {
                            relatedTarget: l,
                            direction: r,
                            from: o,
                            to: u
                        });
                        if (I(this._element).hasClass(V)) {
                            I(l).addClass(i), xn.reflow(l), I(a).addClass(n), I(l).addClass(n);
                            var h = xn.getTransitionDurationFromElement(a);
                            I(a).one(xn.TRANSITION_END, function() {
                                I(l).removeClass(n + " " + i).addClass(Y), I(a).removeClass(Y + " " + i + " " + n), s._isSliding = !1, setTimeout(function() {
                                    return I(s._element).trigger(d)
                                }, 0)
                            }).emulateTransitionEnd(h)
                        } else I(a).removeClass(Y), I(l).addClass(Y), this._isSliding = !1, I(this._element).trigger(d);
                        c && this.cycle()
                    }
                    ...
                    return this.each(function() {
                        ...
                        if (e || (e = new s(this, t), I(this).data(P, e)), "number" == typeof i) e.to(i);
                    ...
                    var t = xn.getSelectorFromElement(this);
                    if (t) {
                        var n = I(t)[0];
                        if (n && I(n).hasClass(W)) {
                            var i = l({}, I(n).data(), I(this).data()),
                                r = this.getAttribute("data-slide-to");
                            r && (i.interval = !1), s._jQueryInterface.call(I(n), i), r && I(n).data(P).to(r), e.preventDefault()
                        }
                    }
                }, a(s, null, [{
                    key: "VERSION",
            ...
            }(), I(document).on(F.CLICK_DATA_API, K.DATA_SLIDE, Z._dataApiClickHandler), I(window).on(F.LOAD_DATA_API, function() {
                for (var e = [].slice.call(document.querySelectorAll(K.DATA_RIDE)), t = 0, n = e.length; t < n; t++) {
                    var i = I(e[t]);
                    Z._jQueryInterface.call(i, i.data())
                }
            }), I.fn[L] = Z._jQueryInterface, I.fn[L].Constructor = Z, I.fn[L].noConflict = function() {
                return I.fn[L] = j, Z._jQueryInterface
            }, Z),
            Cn = (ee = "collapse", ne = "." + (te = "bs.collapse"), ie = (J = t).fn[ee], re = {
                toggle: !0,
                parent: ""
            }, se = {
                toggle: "boolean",
            ...
            }, oe = "show", le = "collapse", ue = "collapsing", ce = "collapsed", de = "width", he = "height", pe = {
                ...
                function o(t, e) {
                    ...
                    for (var n = [].slice.call(document.querySelectorAll(pe.DATA_TOGGLE)), i = 0, r = n.length; i < r; i++) {
                        var s = n[i],
                            a = xn.getSelectorFromElement(s),
                ...
                var e = o.prototype;
                return e.toggle = function() {
                    J(this._element).hasClass(oe) ? this.hide() : this.show()
                }, e.show = function() {
                    var e, t, n = this;
                    if (!this._isTransitioning && !J(this._element).hasClass(oe) && (this._parent && 0 === (e = [].slice.call(this._parent.querySelectorAll(pe.ACTIVES)).filter(function(e) {
                            return e.getAttribute("data-parent") === n._config.parent
                        })).length && (e = null), !(e && (t = J(e).not(this._selector).data(te)) && t._isTransitioning))) {
                        var i = J.Event(ae.SHOW);
                        if (J(this._element).trigger(i), !i.isDefaultPrevented()) {
                            e && (o._jQueryInterface.call(J(e).not(this._selector), "hide"), t || J(e).data(te, null));
                            var r = this._getDimension();
                            J(this._element).removeClass(le).addClass(ue), this._element.style[r] = 0, this._triggerArray.length && J(this._triggerArray).removeClass(ce).attr("aria-expanded", !0), this.setTransitioning(!0);
                            var s = "scroll" + (r[0].toUpperCase() + r.slice(1)),
                                a = xn.getTransitionDurationFromElement(this._element);
                            J(this._element).one(xn.TRANSITION_END, function() {
                                J(n._element).removeClass(ue).addClass(le).addClass(oe), n._element.style[r] = "", n.setTransitioning(!1), J(n._element).trigger(ae.SHOWN)
                            }).emulateTransitionEnd(a), this._element.style[r] = this._element[s] + "px"
                        }
                    }
                }, e.hide = function() {
                    var e = this;
                    if (!this._isTransitioning && J(this._element).hasClass(oe)) {
                        var t = J.Event(ae.HIDE);
                        if (J(this._element).trigger(t), !t.isDefaultPrevented()) {
                            var n = this._getDimension();
                            this._element.style[n] = this._element.getBoundingClientRect()[n] + "px", xn.reflow(this._element), J(this._element).addClass(ue).removeClass(le).removeClass(oe);
                            var i = this._triggerArray.length;
                            if (0 < i)
                                for (var r = 0; r < i; r++) {
                                    var s = this._triggerArray[r],
                                        a = xn.getSelectorFromElement(s);
                                    if (null !== a) J([].slice.call(document.querySelectorAll(a))).hasClass(oe) || J(s).addClass(ce).attr("aria-expanded", !1)
                                }
                            this.setTransitioning(!0);
                            this._element.style[n] = "";
                            var o = xn.getTransitionDurationFromElement(this._element);
                            J(this._element).one(xn.TRANSITION_END, function() {
                                e.setTransitioning(!1), J(e._element).removeClass(ue).addClass(le).trigger(ae.HIDDEN)
                    ...
                    return (e = l({}, re, e)).toggle = Boolean(e.toggle), xn.typeCheckConfig(ee, e, se), e
                }, e._getDimension = function() {
                    return J(this._element).hasClass(de) ? de : he
                }, e._getParent = function() {
                    var n = this,
                        e = null;
                    xn.isElement(this._config.parent) ? (e = this._config.parent, void 0 !== this._config.parent.jquery && (e = this._config.parent[0])) : e = document.querySelector(this._config.parent);
                    ...
                    if (e) {
                        var n = J(e).hasClass(oe);
                        t.length && J(t).toggleClass(ce, !n).attr("aria-expanded", n)
                    }
                    ...
                    return this.each(function() {
                        var e = J(this),
                            t = e.data(te),
                            n = l({}, re, e.data(), "object" == typeof i && i ? i : {});
                        if (!t && n.toggle && /show|hide/.test(i) && (n.toggle = !1), t || (t = new o(this, n), e.data(te, t)), "string" == typeof i) {
            ...
            }(), J(document).on(ae.CLICK_DATA_API, pe.DATA_TOGGLE, function(e) {
                "A" === e.currentTarget.tagName && e.preventDefault();
                var n = J(this),
                    t = xn.getSelectorFromElement(this),
                    i = [].slice.call(document.querySelectorAll(t));
                J(i).each(function() {
                    var e = J(this),
                        t = e.data(te) ? "toggle" : n.data();
                    fe._jQueryInterface.call(e, t)
                })
            }), J.fn[ee] = fe._jQueryInterface, J.fn[ee].Constructor = fe, J.fn[ee].noConflict = function() {
                return J.fn[ee] = ie, fe._jQueryInterface
            }, fe),
            _n = (ve = "dropdown", ye = "." + (ge = "bs.dropdown"), be = ".data-api", we = (me = t).fn[ve], xe = new RegExp("38|40|27"), Ee = {
                HIDE: "hide" + ye,
                HIDDEN: "hidden" + ye,
                SHOW: "show" + ye,
                SHOWN: "shown" + ye,
            ...
            }, Te = "disabled", Se = "show", Ce = "dropup", _e = "dropright", ke = "dropleft", Ae = "dropdown-menu-right", De = "position-static", Oe = '[data-toggle="dropdown"]', Me = ".dropdown form", Ie = ".dropdown-menu", Le = ".navbar-nav", Pe = ".dropdown-menu .dropdown-item:not(.disabled):not(:disabled)", Ne = "top-start", je = "top-end", ze = "bottom-start", He = "bottom-end", qe = "right-start", Re = "left-start", $e = {
                offset: 0,
                flip: !0,
                ...
                return e.toggle = function() {
                    if (!this._element.disabled && !me(this._element).hasClass(Te)) {
                        var e = u._getParentFromElement(this._element),
                            t = me(this._menu).hasClass(Se);
                        if (u._clearMenus(), !t) {
                            var n = {
                                    relatedTarget: this._element
                                },
                                i = me.Event(Ee.SHOW, n);
                            if (me(e).trigger(i), !i.isDefaultPrevented()) {
                                if (!this._inNavbar) {
                                    if (void 0 === c) throw new TypeError("Bootstrap dropdown require Popper.js (https://popper.js.org)");
                                    var r = this._element;
                                    "parent" === this._config.reference ? r = e : xn.isElement(this._config.reference) && (r = this._config.reference, void 0 !== this._config.reference.jquery && (r = this._config.reference[0])), "scrollParent" !== this._config.boundary && me(e).addClass(De), this._popper = new c(r, this._menu, this._getPopperConfig())
                                }
                                "ontouchstart" in document.documentElement && 0 === me(e).closest(Le).length && me(document.body).children().on("mouseover", null, me.noop), this._element.focus(), this._element.setAttribute("aria-expanded", !0), me(this._menu).toggleClass(Se), me(e).toggleClass(Se).trigger(me.Event(Ee.SHOWN, n))
                            }
                        }
                    }
                }, e.dispose = function() {
                    ...
                    return e = l({}, this.constructor.Default, me(this._element).data(), e), xn.typeCheckConfig(ve, e, this.constructor.DefaultType), e
                    ...
                    var e = me(this._element.parentNode),
                        t = ze;
                    return e.hasClass(Ce) ? (t = Ne, me(this._menu).hasClass(Ae) && (t = je)) : e.hasClass(_e) ? t = qe : e.hasClass(ke) ? t = Re : me(this._menu).hasClass(Ae) && (t = He), t
                    ...
                    return this.each(function() {
                        ...
                        if (e || (e = new u(this, "object" == typeof t ? t : null), me(this).data(ge, e)), "string" == typeof t) {
                    ...
                    if (!e || 3 !== e.which && ("keyup" !== e.type || 9 === e.which))
                        for (var t = [].slice.call(document.querySelectorAll(Oe)), n = 0, i = t.length; n < i; n++) {
                            ...
                            if (e && "click" === e.type && (a.clickEvent = e), s) {
                                var o = s._menu;
                                if (me(r).hasClass(Se) && !(e && ("click" === e.type && /input|textarea/i.test(e.target.tagName) || "keyup" === e.type && 9 === e.which) && me.contains(r, e.target))) {
                                    var l = me.Event(Ee.HIDE, a);
                                    me(r).trigger(l), l.isDefaultPrevented() || ("ontouchstart" in document.documentElement && me(document.body).children().off("mouseover", null, me.noop), t[n].setAttribute("aria-expanded", "false"), me(o).removeClass(Se), me(r).removeClass(Se).trigger(me.Event(Ee.HIDDEN, a)))
                                }
                            }
                        }
                    ...
                    if ((/input|textarea/i.test(e.target.tagName) ? !(32 === e.which || 27 !== e.which && (40 !== e.which && 38 !== e.which || me(e.target).closest(Ie).length)) : xe.test(e.which)) && (e.preventDefault(), e.stopPropagation(), !this.disabled && !me(this).hasClass(Te))) {
                        var t = u._getParentFromElement(this),
                            n = me(t).hasClass(Se);
                        if ((n || 27 === e.which && 32 === e.which) && (!n || 27 !== e.which && 32 !== e.which)) {
                            var i = [].slice.call(t.querySelectorAll(Pe));
                            if (0 !== i.length) {
            ...
            }(), me(document).on(Ee.KEYDOWN_DATA_API, Oe, Fe._dataApiKeydownHandler).on(Ee.KEYDOWN_DATA_API, Ie, Fe._dataApiKeydownHandler).on(Ee.CLICK_DATA_API + " " + Ee.KEYUP_DATA_API, Fe._clearMenus).on(Ee.CLICK_DATA_API, Oe, function(e) {
                e.preventDefault(), e.stopPropagation(), Fe._jQueryInterface.call(me(this), "toggle")
            }).on(Ee.CLICK_DATA_API, Me, function(e) {
                e.stopPropagation()
            }), me.fn[ve] = Fe._jQueryInterface, me.fn[ve].Constructor = Fe, me.fn[ve].noConflict = function() {
                return me.fn[ve] = we, Fe._jQueryInterface
            }, Fe),
            kn = (Ye = "modal", Xe = "." + (Ve = "bs.modal"), Ge = (We = t).fn[Ye], Ue = {
                backdrop: !0,
                keyboard: !0,
                focus: !0,
                show: !0
            ...
            }, Ze = "modal-scrollbar-measure", Je = "modal-backdrop", et = "modal-open", tt = "fade", nt = "show", it = {
                DIALOG: ".modal-dialog",
                ...
                function r(e, t) {
                    this._config = this._getConfig(t), this._element = e, this._dialog = e.querySelector(it.DIALOG), this._backdrop = null, this._isShown = !1, this._isBodyOverflowing = !1, this._ignoreBackdropClick = !1, this._scrollbarWidth = 0
                }
                var e = r.prototype;
                return e.toggle = function(e) {
                    ...
                    if (!this._isTransitioning && !this._isShown) {
                        ...
                        var n = We.Event(Ke.SHOW, {
                            relatedTarget: e
                        });
                        We(this._element).trigger(n), this._isShown || n.isDefaultPrevented() || (this._isShown = !0, this._checkScrollbar(), this._setScrollbar(), this._adjustDialog(), We(document.body).addClass(et), this._setEscapeEvent(), this._setResizeEvent(), We(this._element).on(Ke.CLICK_DISMISS, it.DATA_DISMISS, function(e) {
                            return t.hide(e)
                        }), We(this._dialog).on(Ke.MOUSEDOWN_DISMISS, function() {
                            We(t._element).one(Ke.MOUSEUP_DISMISS, function(e) {
                    ...
                    if (e && e.preventDefault(), !this._isTransitioning && this._isShown) {
                        var n = We.Event(Ke.HIDE);
                        if (We(this._element).trigger(n), this._isShown && !n.isDefaultPrevented()) {
                            this._isShown = !1;
                            var i = We(this._element).hasClass(tt);
                            if (i && (this._isTransitioning = !0), this._setEscapeEvent(), this._setResizeEvent(), We(document).off(Ke.FOCUSIN), We(this._element).removeClass(nt), We(this._element).off(Ke.CLICK_DISMISS), We(this._dialog).off(Ke.MOUSEDOWN_DISMISS), i) {
                                var r = xn.getTransitionDurationFromElement(this._element);
                                We(this._element).one(xn.TRANSITION_END, function(e) {
                    ...
                    We.removeData(this._element, Ve), We(window, document, this._element, this._backdrop).off(Xe), this._config = null, this._element = null, this._dialog = null, this._backdrop = null, this._isShown = null, this._isBodyOverflowing = null, this._ignoreBackdropClick = null, this._scrollbarWidth = null
                }, e.handleUpdate = function() {
                    this._adjustDialog()
                }, e._getConfig = function(e) {
                    return e = l({}, Ue, e), xn.typeCheckConfig(Ye, e, Qe), e
                }, e._showElement = function(e) {
                    var t = this,
                        n = We(this._element).hasClass(tt);
                    this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE || document.body.appendChild(this._element), this._element.style.display = "block", this._element.removeAttribute("aria-hidden"), this._element.scrollTop = 0, n && xn.reflow(this._element), We(this._element).addClass(nt), this._config.focus && this._enforceFocus();
                    var i = We.Event(Ke.SHOWN, {
                            relatedTarget: e
                        }),
                        r = function() {
                            t._config.focus && t._element.focus(), t._isTransitioning = !1, We(t._element).trigger(i)
                        };
                    if (n) {
                        var s = xn.getTransitionDurationFromElement(this._element);
                        We(this._dialog).one(xn.TRANSITION_END, r).emulateTransitionEnd(s)
                    } else r()
                }, e._enforceFocus = function() {
                    var t = this;
                    We(document).off(Ke.FOCUSIN).on(Ke.FOCUSIN, function(e) {
                        document !== e.target && t._element !== e.target && 0 === We(t._element).has(e.target).length && t._element.focus()
                    })
                }, e._setEscapeEvent = function() {
                    var t = this;
                    this._isShown && this._config.keyboard ? We(this._element).on(Ke.KEYDOWN_DISMISS, function(e) {
                        27 === e.which && (e.preventDefault(), t.hide())
                    }) : this._isShown || We(this._element).off(Ke.KEYDOWN_DISMISS)
                }, e._setResizeEvent = function() {
                    var t = this;
                    this._isShown ? We(window).on(Ke.RESIZE, function(e) {
                        return t.handleUpdate(e)
                    }) : We(window).off(Ke.RESIZE)
                }, e._hideModal = function() {
                    var e = this;
                    this._element.style.display = "none", this._element.setAttribute("aria-hidden", !0), this._isTransitioning = !1, this._showBackdrop(function() {
                        We(document.body).removeClass(et), e._resetAdjustments(), e._resetScrollbar(), We(e._element).trigger(Ke.HIDDEN)
                    })
                }, e._removeBackdrop = function() {
                    this._backdrop && (We(this._backdrop).remove(), this._backdrop = null)
                }, e._showBackdrop = function(e) {
                    var t = this,
                        n = We(this._element).hasClass(tt) ? tt : "";
                    if (this._isShown && this._config.backdrop) {
                        if (this._backdrop = document.createElement("div"), this._backdrop.className = Je, n && this._backdrop.classList.add(n), We(this._backdrop).appendTo(document.body), We(this._element).on(Ke.CLICK_DISMISS, function(e) {
                                t._ignoreBackdropClick ? t._ignoreBackdropClick = !1 : e.target === e.currentTarget && ("static" === t._config.backdrop ? t._element.focus() : t.hide())
                            }), n && xn.reflow(this._backdrop), We(this._backdrop).addClass(nt), !e) return;
                        if (!n) return void e();
                        var i = xn.getTransitionDurationFromElement(this._backdrop);
                        We(this._backdrop).one(xn.TRANSITION_END, e).emulateTransitionEnd(i)
                    } else if (!this._isShown && this._backdrop) {
                        We(this._backdrop).removeClass(nt);
                        var r = function() {
                            t._removeBackdrop(), e && e()
                        };
                        if (We(this._element).hasClass(tt)) {
                            var s = xn.getTransitionDurationFromElement(this._backdrop);
                            We(this._backdrop).one(xn.TRANSITION_END, r).emulateTransitionEnd(s)
                        } else r()
                    } else e && e()
                    ...
                    if (this._isBodyOverflowing) {
                        ...
                        We(e).each(function(e, t) {
                            var n = t.style.paddingRight,
                                i = We(t).css("padding-right");
                            We(t).data("padding-right", n).css("padding-right", parseFloat(i) + r._scrollbarWidth + "px")
                        }), We(t).each(function(e, t) {
                            var n = t.style.marginRight,
                                i = We(t).css("margin-right");
                            We(t).data("margin-right", n).css("margin-right", parseFloat(i) - r._scrollbarWidth + "px")
                        });
                        var n = document.body.style.paddingRight,
                            i = We(document.body).css("padding-right");
                        We(document.body).data("padding-right", n).css("padding-right", parseFloat(i) + this._scrollbarWidth + "px")
                    }
                }, e._resetScrollbar = function() {
                    var e = [].slice.call(document.querySelectorAll(it.FIXED_CONTENT));
                    We(e).each(function(e, t) {
                        var n = We(t).data("padding-right");
                        We(t).removeData("padding-right"), t.style.paddingRight = n || ""
                    });
                    var t = [].slice.call(document.querySelectorAll("" + it.STICKY_CONTENT));
                    We(t).each(function(e, t) {
                        var n = We(t).data("margin-right");
                        void 0 !== n && We(t).css("margin-right", n).removeData("margin-right")
                    });
                    var n = We(document.body).data("padding-right");
                    We(document.body).removeData("padding-right"), document.body.style.paddingRight = n || ""
                    ...
                    return this.each(function() {
                        var e = We(this).data(Ve),
                            t = l({}, Ue, We(this).data(), "object" == typeof n && n ? n : {});
                        if (e || (e = new r(this, t), We(this).data(Ve, e)), "string" == typeof n) {
                            if (void 0 === e[n]) throw new TypeError('No method named "' + n + '"');
                            e[n](i)
            ...
            }(), We(document).on(Ke.CLICK_DATA_API, it.DATA_TOGGLE, function(e) {
                var t, n = this,
                    i = xn.getSelectorFromElement(this);
                i && (t = document.querySelector(i));
                var r = We(t).data(Ve) ? "toggle" : l({}, We(t).data(), We(this).data());
                "A" !== this.tagName && "AREA" !== this.tagName || e.preventDefault();
                var s = We(t).one(Ke.SHOW, function(e) {
                    e.isDefaultPrevented() || s.one(Ke.HIDDEN, function() {
                        We(n).is(":visible") && n.focus()
                    })
                });
                rt._jQueryInterface.call(We(t), r, this)
            }), We.fn[Ye] = rt._jQueryInterface, We.fn[Ye].Constructor = rt, We.fn[Ye].noConflict = function() {
                return We.fn[Ye] = Ge, rt._jQueryInterface
            }, rt),
            An = (at = "tooltip", lt = "." + (ot = "bs.tooltip"), ut = (st = t).fn[at], ct = "bs-tooltip", dt = new RegExp("(^|\\s)" + ct + "\\S+", "g"), ft = {
                animation: !0,
            ...
            }, yt = "fade", bt = "show", wt = ".tooltip-inner", xt = ".arrow", Et = "hover", Tt = "focus", St = "click", Ct = "manual", _t = function() {
                function i(e, t) {
                ...
                return e.enable = function() {
                    ...
                    if (this.isWithContent() && this._isEnabled) {
                        st(this.element).trigger(e);
                        var n = st.contains(this.element.ownerDocument.documentElement, this.element);
                        if (e.isDefaultPrevented() || !n) return;
                        var i = this.getTipElement(),
                            r = xn.getUID(this.constructor.NAME);
                        i.setAttribute("id", r), this.element.setAttribute("aria-describedby", r), this.setContent(), this.config.animation && st(i).addClass(yt);
                        var s = "function" == typeof this.config.placement ? this.config.placement.call(this, i, this.element) : this.config.placement,
                            a = this._getAttachment(s);
                        this.addAttachmentClass(a);
                        var o = !1 === this.config.container ? document.body : st(document).find(this.config.container);
                        st(i).data(this.constructor.DATA_KEY, this), st.contains(this.element.ownerDocument.documentElement, this.tip) || st(i).appendTo(o), st(this.element).trigger(this.constructor.Event.INSERTED), this._popper = new c(this.element, i, {
                            placement: a,
                            modifiers: {
                                offset: {
                        ...
                        }), st(i).addClass(bt), "ontouchstart" in document.documentElement && st(document.body).children().on("mouseover", null, st.noop);
                        var l = function() {
                            t.config.animation && t._fixTransition();
                            var e = t._hoverState;
                            t._hoverState = null, st(t.element).trigger(t.constructor.Event.SHOWN), e === vt && t._leave(null, t)
                        };
                        if (st(this.tip).hasClass(yt)) {
                            var u = xn.getTransitionDurationFromElement(this.tip);
                            st(this.tip).one(xn.TRANSITION_END, l).emulateTransitionEnd(u)
                        } else l()
                    }
                }, e.hide = function(e) {
                    var t = this,
                    ...
                    if (st(this.element).trigger(i), !i.isDefaultPrevented()) {
                        if (st(n).removeClass(bt), "ontouchstart" in document.documentElement && st(document.body).children().off("mouseover", null, st.noop), this._activeTrigger[St] = !1, this._activeTrigger[Tt] = !1, this._activeTrigger[Et] = !1, st(this.tip).hasClass(yt)) {
                            var s = xn.getTransitionDurationFromElement(n);
                            st(n).one(xn.TRANSITION_END, r).emulateTransitionEnd(s)
                        } else r();
                        this._hoverState = ""
                    }
                }, e.update = function() {
                    ...
                    st(this.getTipElement()).addClass(ct + "-" + e)
                }, e.getTipElement = function() {
                    return this.tip = this.tip || st(this.config.template)[0], this.tip
                }, e.setContent = function() {
                    var e = this.getTipElement();
                    this.setElementContent(st(e.querySelectorAll(wt)), this.getTitle()), st(e).removeClass(yt + " " + bt)
                    ...
                    this.config.trigger.split(" ").forEach(function(e) {
                        if ("click" === e) st(i.element).on(i.constructor.Event.CLICK, i.config.selector, function(e) {
                            return i.toggle(e)
                        });
                        else if (e !== Ct) {
                            var t = e === Et ? i.constructor.Event.MOUSEENTER : i.constructor.Event.FOCUSIN,
                                n = e === Et ? i.constructor.Event.MOUSELEAVE : i.constructor.Event.FOCUSOUT;
                            st(i.element).on(t, i.config.selector, function(e) {
                                return i._enter(e)
                            }).on(n, i.config.selector, function(e) {
                                return i._leave(e)
                            })
                        }
                        st(i.element).closest(".modal").on("hide.bs.modal", function() {
                            return i.hide()
                        })
                    ...
                    (t = t || st(e.currentTarget).data(n)) || (t = new this.constructor(e.currentTarget, this._getDelegateConfig()), st(e.currentTarget).data(n, t)), e && (t._activeTrigger["focusin" === e.type ? Tt : Et] = !0), st(t.getTipElement()).hasClass(bt) || t._hoverState === mt ? t._hoverState = mt : (clearTimeout(t._timeout), t._hoverState = mt, t.config.delay && t.config.delay.show ? t._timeout = setTimeout(function() {
                        t._hoverState === mt && t.show()
                    }, t.config.delay.show) : t.show())
                }, e._leave = function(e, t) {
                    var n = this.constructor.DATA_KEY;
                    (t = t || st(e.currentTarget).data(n)) || (t = new this.constructor(e.currentTarget, this._getDelegateConfig()), st(e.currentTarget).data(n, t)), e && (t._activeTrigger["focusout" === e.type ? Tt : Et] = !1), t._isWithActiveTrigger() || (clearTimeout(t._timeout), t._hoverState = vt, t.config.delay && t.config.delay.hide ? t._timeout = setTimeout(function() {
                    ...
                    return "number" == typeof(e = l({}, this.constructor.Default, st(this.element).data(), "object" == typeof e && e ? e : {})).delay && (e.delay = {
                        show: e.delay,
                        hide: e.delay
                    ...
                    null === e.getAttribute("x-placement") && (st(e).removeClass(yt), this.config.animation = !1, this.hide(), this.show(), this.config.animation = t)
                }, i._jQueryInterface = function(n) {
                    return this.each(function() {
                        var e = st(this).data(ot),
                            t = "object" == typeof n && n;
                        if ((e || !/dispose|hide/.test(n)) && (e || (e = new i(this, t), st(this).data(ot, e)), "string" == typeof n)) {
                            if (void 0 === e[n]) throw new TypeError('No method named "' + n + '"');
                            e[n]()
                        }
                    })
            ...
            }(), st.fn[at] = _t._jQueryInterface, st.fn[at].Constructor = _t, st.fn[at].noConflict = function() {
                return st.fn[at] = ut, _t._jQueryInterface
            }, _t),
            Dn = (At = "popover", Ot = "." + (Dt = "bs.popover"), Mt = (kt = t).fn[At], It = "bs-popover", Lt = new RegExp("(^|\\s)" + It + "\\S+", "g"), Pt = l({}, An.Default, {
                placement: "right",
                trigger: "click",
                content: "",
            ...
            }), jt = "fade", Ht = ".popover-header", qt = ".popover-body", Rt = {
                HIDE: "hide" + Ot,
                HIDDEN: "hidden" + Ot,
                SHOW: (zt = "show") + Ot,
                SHOWN: "shown" + Ot,
                ...
                return r.isWithContent = function() {
                    ...
                    kt(this.getTipElement()).addClass(It + "-" + e)
                    ...
                    "function" == typeof t && (t = t.call(this.element)), this.setElementContent(e.find(qt), t), e.removeClass(jt + " " + zt)
                    ...
                    return this.each(function() {
                        var e = kt(this).data(Dt),
                            t = "object" == typeof n ? n : null;
                        if ((e || !/destroy|hide/.test(n)) && (e || (e = new i(this, t), kt(this).data(Dt, e)), "string" == typeof n)) {
                            if (void 0 === e[n]) throw new TypeError('No method named "' + n + '"');
                            e[n]()
                        }
                    })
            ...
            }(An), kt.fn[At] = $t._jQueryInterface, kt.fn[At].Constructor = $t, kt.fn[At].noConflict = function() {
                return kt.fn[At] = Mt, $t._jQueryInterface
            }, $t),
            On = (Ft = "scrollspy", Yt = "." + (Wt = "bs.scrollspy"), Vt = (Bt = t).fn[Ft], Xt = {
                offset: 10,
                method: "auto",
                target: ""
            }, Gt = {
                ...
                return e.refresh = function() {
                    var t = this,
                        e = this._scrollElement === this._scrollElement.window ? Jt : en,
                    ...
                    this._offsets = [], this._targets = [], this._scrollHeight = this._getScrollHeight(), [].slice.call(document.querySelectorAll(this._selector)).map(function(e) {
                        ...
                        if (n && (t = document.querySelector(n)), t) {
                            ...
                            if (i.width || i.height) return [Bt(t)[r]().top + s, n]
                        }
                        return null
                    }).filter(function(e) {
                        return e
                    ...
                    Bt.removeData(this._element, Wt), Bt(this._scrollElement).off(Yt), this._element = null, this._scrollElement = null, this._config = null, this._selector = null, this._offsets = null, this._targets = null, this._activeTarget = null, this._scrollHeight = null
                }, e._getConfig = function(e) {
                    if ("string" != typeof(e = l({}, Xt, "object" == typeof e && e ? e : {})).target) {
                        var t = Bt(e.target).attr("id");
                        t || (t = xn.getUID(Ft), Bt(e.target).attr("id", t)), e.target = "#" + t
                    }
                    return xn.typeCheckConfig(Ft, e, Gt), e
                    ...
                    var n = Bt([].slice.call(document.querySelectorAll(e.join(","))));
                    n.hasClass(Qt) ? (n.closest(Zt.DROPDOWN).find(Zt.DROPDOWN_TOGGLE).addClass(Kt), n.addClass(Kt)) : (n.addClass(Kt), n.parents(Zt.NAV_LIST_GROUP).prev(Zt.NAV_LINKS + ", " + Zt.LIST_ITEMS).addClass(Kt), n.parents(Zt.NAV_LIST_GROUP).prev(Zt.NAV_ITEMS).children(Zt.NAV_LINKS).addClass(Kt)), Bt(this._scrollElement).trigger(Ut.ACTIVATE, {
                        relatedTarget: t
                    })
                }, e._clear = function() {
                    var e = [].slice.call(document.querySelectorAll(this._selector));
                    Bt(e).filter(Zt.ACTIVE).removeClass(Kt)
                }, n._jQueryInterface = function(t) {
                    return this.each(function() {
                        var e = Bt(this).data(Wt);
                        if (e || (e = new n(this, "object" == typeof t && t), Bt(this).data(Wt, e)), "string" == typeof t) {
                            if (void 0 === e[t]) throw new TypeError('No method named "' + t + '"');
                            e[t]()
                        }
                    })
            ...
            }(), Bt(window).on(Ut.LOAD_DATA_API, function() {
                for (var e = [].slice.call(document.querySelectorAll(Zt.DATA_SPY)), t = e.length; t--;) {
                    var n = Bt(e[t]);
                    tn._jQueryInterface.call(n, n.data())
                }
            }), Bt.fn[Ft] = tn._jQueryInterface, Bt.fn[Ft].Constructor = tn, Bt.fn[Ft].noConflict = function() {
                return Bt.fn[Ft] = Vt, tn._jQueryInterface
            }, tn),
            Mn = (sn = "." + (rn = "bs.tab"), an = (nn = t).fn.tab, on = {
                HIDE: "hide" + sn,
                HIDDEN: "hidden" + sn,
                SHOW: "show" + sn,
                SHOWN: "shown" + sn,
                CLICK_DATA_API: "click.bs.tab.data-api"
            }, ln = "dropdown-menu", un = "active", cn = "disabled", dn = "fade", hn = "show", pn = ".dropdown", fn = ".nav, .list-group", mn = ".active", vn = "> li > .active", gn = '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', yn = ".dropdown-toggle", bn = "> .dropdown-menu .active", wn = function() {
                function i(e) {
                    this._element = e
                }
                var e = i.prototype;
                return e.show = function() {
                    var n = this;
                    if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && nn(this._element).hasClass(un) || nn(this._element).hasClass(cn))) {
                        var e, i, t = nn(this._element).closest(fn)[0],
                            r = xn.getSelectorFromElement(this._element);
                        if (t) {
                            var s = "UL" === t.nodeName ? vn : mn;
                            i = (i = nn.makeArray(nn(t).find(s)))[i.length - 1]
                        }
                        var a = nn.Event(on.HIDE, {
                                relatedTarget: this._element
                            }),
                            o = nn.Event(on.SHOW, {
                                relatedTarget: i
                            });
                        if (i && nn(i).trigger(a), nn(this._element).trigger(o), !o.isDefaultPrevented() && !a.isDefaultPrevented()) {
                            r && (e = document.querySelector(r)), this._activate(this._element, t);
                            var l = function() {
                                var e = nn.Event(on.HIDDEN, {
                                        relatedTarget: n._element
                                    }),
                                    t = nn.Event(on.SHOWN, {
                                        relatedTarget: i
                                    });
                                nn(i).trigger(e), nn(n._element).trigger(t)
                            };
                            e ? this._activate(e, e.parentNode, l) : l()
                        }
                    }
                }, e.dispose = function() {
                    nn.removeData(this._element, rn), this._element = null
                }, e._activate = function(e, t, n) {
                    var i = this,
                        r = ("UL" === t.nodeName ? nn(t).find(vn) : nn(t).children(mn))[0],
                        s = n && r && nn(r).hasClass(dn),
                        a = function() {
                            return i._transitionComplete(e, r, n)
                        };
                    if (r && s) {
                        var o = xn.getTransitionDurationFromElement(r);
                        nn(r).one(xn.TRANSITION_END, a).emulateTransitionEnd(o)
                    } else a()
                }, e._transitionComplete = function(e, t, n) {
                    if (t) {
                        nn(t).removeClass(hn + " " + un);
                        var i = nn(t.parentNode).find(bn)[0];
                        i && nn(i).removeClass(un), "tab" === t.getAttribute("role") && t.setAttribute("aria-selected", !1)
                    }
                    if (nn(e).addClass(un), "tab" === e.getAttribute("role") && e.setAttribute("aria-selected", !0), xn.reflow(e), nn(e).addClass(hn), e.parentNode && nn(e.parentNode).hasClass(ln)) {
                        var r = nn(e).closest(pn)[0];
                        if (r) {
                    ...
                    return this.each(function() {
                        var e = nn(this),
                            t = e.data(rn);
                        if (t || (t = new i(this), e.data(rn, t)), "string" == typeof n) {
            ...
            }(), nn(document).on(on.CLICK_DATA_API, gn, function(e) {
                e.preventDefault(), wn._jQueryInterface.call(nn(this), "show")
            }), nn.fn.tab = wn._jQueryInterface, nn.fn.tab.Constructor = wn, nn.fn.tab.noConflict = function() {
                return nn.fn.tab = an, wn._jQueryInterface
            }, wn);
        ! function(e) {
            if (void 0 === e) throw new TypeError("Bootstrap's JavaScript requires jQuery. jQuery must be included before Bootstrap's JavaScript.");
            var t = e.fn.jquery.split(" ")[0].split(".");
            if (t[0] < 2 && t[1] < 9 || 1 === t[0] && 9 === t[1] && t[2] < 1 || 4 <= t[0]) throw new Error("Bootstrap's JavaScript requires at least jQuery v1.9.1 but less than v4.0.0")
        }(t), e.Util = xn, e.Alert = En, e.Button = Tn, e.Carousel = Sn, e.Collapse = Cn, e.Dropdown = _n, e.Modal = kn, e.Popover = Dn, e.Scrollspy = On, e.Tab = Mn, e.Tooltip = An, Object.defineProperty(e, "__esModule", {
            value: !0
        })
    }),
    function() {
        ...
        n.fn.counterUp = function(e) {
            ...
            return this.each(function() {
                ...
                l.waypoint(function() {
                    ...
                    n = n.replace(/,/g, "");
                    /^[0-9]+$/.test(n);
                    for (var r = /^[0-9]+\.[0-9]+$/.test(n), s = r ? (n.split(".")[1] || []).length : 0, a = t; 1 <= a; a--) {
                        var o = parseInt(n / t * a);
                        if (r && (o = parseFloat(n / t * a).toFixed(s)), i)
                            for (;
                    ...
                    l.data("counterup-func", function() {
                        l.text(l.data("counterup-nums").shift()), l.data("counterup-nums").length ? setTimeout(l.data("counterup-func"), u.delay) : (l.data("counterup-nums"), l.data("counterup-nums", null), l.data("counterup-func", null))
        ...
        l.extend(i.prototype, {
            ...
            _loadStepContent: function(t) {
                ...
                if (!(s && 0 < s.length) || r.data("has-content") && this.options.contentCache) this._transitPage(t);
                    ...
                    var a = 0 < r.length ? l(r.attr("href"), this.main) : null,
                        o = l.extend(!0, {}, {
                            url: s,
                            type: "POST",
                            data: {
                            ...
                            success: function(e) {
                                e && 0 < e.length && (r.data("has-content", !0), a.html(e)), i._loader("hide"), i._transitPage(t)
                            }
            ...
            _transitPage: function(e) {
                var t = this,
                    ...
                    a = "";
                null !== this.current_index && this.current_index !== e && (a = this.current_index < e ? "forward" : "backward");
                var o = "middle";
                return 0 === e ? o = "first" : e === this.steps.length - 1 && (o = "final"), this.options.transitionEffect = this.options.transitionEffect.toLowerCase(), this.pages.finish(), "slide" === this.options.transitionEffect ? i && 0 < i.length ? i.slideUp("fast", this.options.transitionEasing, function() {
                    ...
                    l(this).show()
                }) : (i && 0 < i.length && i.hide(), s.show()), this._setURLHash(r.attr("href")), this._setAnchor(e), this._setButtons(e), this._fixHeight(e), this.current_index = e, this._triggerEvent("showStep", [r, this.current_index, a, o]), !0
            },
    ...
    function(e, t) {
        ...
        return function(n) {
            ...
            var m = n(1),
                ...
                w = function(e, t, n) {
                    var i, r, s, a, o = e & w.F,
                        ...
                        c = e & w.P,
                        d = e & w.B,
                        h = l ? m : u ? m[t] || (m[t] = {}) : (m[t] || {}).prototype,
                        p = l ? v : v[t] || (v[t] = {}),
                        f = p.prototype || (p.prototype = {});
                    for (i in l && (n = t), n) s = ((r = !o && h && void 0 !== h[i]) ? h : n)[i], a = d && r ? b(s, m) : c && "function" == typeof s ? b(Function.call, s) : s, h && y(h, i, s, e & w.U), p[i] != s && g(p, i, a), c && f[i] != s && (f[i] = s)
                };
            ...
            var r = function() {
                ...
                return e = r, n = [{
                    ...
                    value: function() {
                        ...
                        var a = r / i,
                            o = n / (i - r),
                            l = Math.max(~~(a * r), this.options.scrollbarMinSize),
                            u = ~~((r - l) * o);
                        this.isVisible[s] = r < i, this.isVisible[s] || this.options.forceVisible ? (e.style.visibility = "visible", this.options.forceVisible ? t.style.visibility = "hidden" : t.style.visibility = "visible", "x" === s ? (t.style.left = "".concat(u, "px"), t.style.width = "".concat(l, "px")) : (t.style.top = "".concat(u, "px"), t.style.height = "".concat(l, "px"))) : e.style.visibility = "hidden"
                    }
                }, {
                    key: "onScrollX",
                    value: function() {
            ...
            e.exports = function(o) {
                return function(e, t) {
                    var n, i, r = String(u(e)),
                        s = l(t),
                        a = r.length;
                    return s < 0 || a <= s ? o ? "" : void 0 : (n = r.charCodeAt(s)) < 55296 || 56319 < n || s + 1 === a || (i = r.charCodeAt(s + 1)) < 56320 || 57343 < i ? o ? r.charAt(s) : n : o ? r.slice(s, s + 2) : i - 56320 + (n - 55296 << 10) + 65536
                }
            }
        }, function(e, t, n) {
            "use strict";
            ...
            e.exports = function(e, t, n, i, r, s, a) {
                ...
                var o, l, u, c = function(e) {
                    ...
                    v = m || c(r),
                    g = r ? h ? c("entries") : v : void 0,
                    y = "Array" == t && f.entries || m;
                if (y && (u = k(y.call(new e))) !== Object.prototype && u.next && (_(u, d, !0), b || T(u, A) || E(u, A, O)), h && m && "values" !== m.name && (p = !0, v = function() {
                        return m.call(this)
                    }), b && !a || !D && !p && f[A] || E(f, A, v), S[t] = v, S[d] = O, r)
                    if (o = {
                            values: h ? v : c("values"),
                            keys: s ? v : c("keys"),
                            entries: g
                        }, a)
                        for (l in o) l in f || x(f, l, o[l]);
                    else w(w.P + w.F * (D || p), t, o);
                return o
            }
        }, function(e, t) {
            e.exports = !1
            ...
            var r = i(6),
                ...
                u = function() {
                    var e, t = i(17)("iframe"),
                        n = a.length;
                    for (t.style.display = "none", i(44).appendChild(t), t.src = "javascript:", (e = t.contentWindow.document).open(), e.write("<script>document.F=Object<\/script>"), e.close(), u = e.F; n--;) delete u.prototype[a[n]];
                    return u()
                };
            e.exports = Object.create || function(e, t) {
                var n;
                return null !== e ? (l.prototype = r(e), n = new l, l.prototype = null, n[o] = e) : n = u(), void 0 === t ? n : s(n, t)
            }
        }, function(e, t, n) {
            var a = n(5),
                o = n(6),
            ...
            e.exports = function(o) {
                return function(e, t, n) {
                    ...
                    if (o && t != t) {
                        ...
                        for (; a < s; a++)
                            if ((o || a in r) && r[a] === t) return o || a || 0;
                    return !o && -1
                }
            }
        }, function(e, t, n) {
            ...
            i(i.S + i.F * !n(52)(function(e) {
                ...
                from: function(e) {
                    var t, n, i, r, s = p(e),
                        ...
                        c = 0,
                        d = y(s);
                    if (u && (l = h(l, 2 < o ? arguments[2] : void 0, 2)), null == d || a == Array && m(d))
                        for (n = new a(t = v(s.length)); c < t; c++) g(n, c, u ? l(s[c], c) : s[c]);
                    else
                        for (r = d.call(s), n = new a; !(i = r.next()).done; c++) g(n, c, u ? f(r, l, [i.value, c], !0) : i.value);
                    return n.length = c, n
                }
            })
        }, function(e, t, n) {
            ...
            e.exports = function(e) {
                ...
                }(t = Object(e), s)) ? n : a ? r(t) : "Object" == (i = r(t)) && "function" == typeof t.callee ? "Arguments" : i
            }
        }, function(e, t, n) {
            var s = n(0)("iterator"),
                a = !1;
            ...
            (function(e) {
                ...
                function b(e) {
                    ...
                    if ("symbol" == typeof(t = e) || (n = t) && "object" == typeof n && h.call(t) == a) return s;
                    var t, n;
                    if (y(e)) {
                ...
                r.exports = function(i, r, e) {
                    ...
                    function o() {
                        var e, t, n = T();
                        if (a(n)) return l(n);
                        p = setTimeout(o, (t = r - ((e = n) - f), g ? E(t, d - (e - m)) : t))
                    }

                    function l(e) {
                        return p = void 0, n && u ? s(e) : (u = c = void 0, h)
                    }
                    ...
                    function t() {
                        ...
                        if (u = arguments, c = this, f = t, n) {
                            if (void 0 === p) return m = e = f, p = setTimeout(o, r), v ? s(e) : h;
                            if (g) return p = setTimeout(o, r), s(f)
                        }
            ...
            function i(e) {
                ...
                var i = getComputedStyle(e),
                    ...
                    o = d(i.width),
                    l = d(i.height);
                if ("border-box" === i.boxSizing && (Math.round(o + s) !== t && (o -= h(i, "left", "right") + s), Math.round(l + a) !== n && (l -= h(i, "top", "bottom") + a)), e !== document.documentElement) {
                    var u = Math.round(o + s) - t,
                        c = Math.round(l + a) - n;
                    1 !== Math.abs(u) && (o -= u), 1 !== Math.abs(c) && (l -= c)
                }
                return p(r.left, r.top, o, l)
            }

            function r(e) {
                return a ? y(e) ? p(0, 0, (t = e.getBBox()).width, t.height) : i(e) : g;
                var t
            }
            ...
            var s = function() {
                ...
                c = "undefined" != typeof navigator && /Trident\/.*rv:11/.test(navigator.userAgent),
                f = "undefined" != typeof MutationObserver && !c,
                m = function() {
            ...
            var w = function(e, t) {
                    var n, i, r, s, a, o, l, u = (i = (n = t).x, r = n.y, s = n.width, a = n.height, o = "undefined" != typeof DOMRectReadOnly ? DOMRectReadOnly : Object, l = Object.create(o.prototype), v(l, {
                        x: i,
                        y: r,
                        width: s,
                        height: a,
            ...
            e.exports = function() {
                ...
                for (var n, i, r = function(e) {
                    ...
                    for (var a in n = Object(arguments[s])) u.call(n, a) && (r[a] = n[a]);
                    if (l) {
                        i = l(n);
                        for (var o = 0; o < i.length; o++) c.call(n, i[o]) && (r[i[o]] = n[i[o]])
                    }
                }
                return r
            }
        }]).default
    }), window.Modernizr = function(i, d, a) {
        function n(e) {
            m.cssText = e
        }
        ...
        function l(e, t, n) {
            ...
            return s(t, "string") || s(t, "undefined") ? o(r, t) : function(e, t, n) {
                for (var i in e) {
                    var r = t[e[i]];
                    if (r !== a) return !1 === n ? e[i] : s(r, "function") ? r.bind(n || t) : r
                }
                return !1
        ...
        var e, u, c, h = {},
            ...
            A = k.slice,
            D = function(e, t, n, i) {
                var r, s, a, o, l = d.createElement("div"),
                    u = d.body,
                    c = u || d.createElement("body");
                if (parseInt(n, 10))
                    for (; n--;)(a = d.createElement("div")).id = i ? i[n] : f + (n + 1), l.appendChild(a);
                return r = ["&#173;", '<style id="s', f, '">', e, "</style>"].join(""), l.id = f, (u ? l : c).innerHTML += r, c.appendChild(l), u || (c.style.background = "", c.style.overflow = "hidden", o = p.style.overflow, p.style.overflow = "hidden", p.appendChild(c)), s = t(l, e), u ? l.parentNode.removeChild(l) : (c.parentNode.removeChild(c), p.style.overflow = o), !!s
            },
            O = (c = {
                select: "input",
                change: "input",
                ...
                t = t || d.createElement(c[e] || "div");
                var n = (e = "on" + e) in t;
                return n || (t.setAttribute || (t = d.createElement("div")), t.setAttribute && t.removeAttribute && (t.setAttribute(e, ""), n = s(t[e], "function"), s(t[e], "undefined") || (t[e] = a), t.removeAttribute(e))), t = null, n
            }),
            M = {}.hasOwnProperty;
        for (var I in u = s(M, "undefined") || s(M.call, "undefined") ? function(e, t) {
                ...
                return O("hashchange", i) && (d.documentMode === a || 7 < d.documentMode)
            }, S.history = function() {
            ...
            }, S) u(S, I) && (e = I.toLowerCase(), h[e] = S[I](), k.push((h[e] ? "" : "no-") + e));
        return h.input || (h.input = function(e) {
                ...
                for (var t, n, i, r = 0, s = e.length; r < s; r++) v.setAttribute("type", n = e[r]), (t = "text" !== v.type) && (v.value = g, v.style.cssText = "position:absolute;visibility:hidden;", /^range$/.test(n) && v.style.WebkitAppearance !== a ? (p.appendChild(v), t = (i = d.defaultView).getComputedStyle && "textfield" !== i.getComputedStyle(v, null).WebkitAppearance && 0 !== v.offsetHeight, p.removeChild(v)) : /^(search|tel)$/.test(n) || (t = /^(url|email)$/.test(n) ? v.checkValidity && !1 === v.checkValidity() : v.value != g)), C[e[r]] = !!t;
                return C
            ...
            function(e, l) {
                ...
                function c(e) {
                    var t = o[e[i]];
                    return t || (t = {}, a++, e[i] = a, o[a] = t), t
                }

                function d(e, t, n) {
                    return t || (t = l), p ? t.createElement(e) : (n || (n = c(t)), !(i = n.cache[e] ? n.cache[e].cloneNode() : s.test(e) ? (n.cache[e] = n.createElem(e)).cloneNode() : n.createElem(e)).canHaveChildren || r.test(e) || i.tagUrn ? i : n.frag.appendChild(i));
                    var i
                }

                function t(e) {
                    e || (e = l);
                    var t, n, i, r, s, a, o = c(e);
                    return f.shivCSS && !h && !o.hasCSS && (o.hasCSS = (r = "article,aside,dialog,figcaption,figure,footer,header,hgroup,main,nav,section{display:block}mark{background:#FF0;color:#000}template{display:none}", s = (i = e).createElement("p"), a = i.getElementsByTagName("head")[0] || i.documentElement, s.innerHTML = "x<style>" + r + "</style>", !!a.insertBefore(s.lastChild, a.firstChild))), p || (t = e, (n = o).cache || (n.cache = {}, n.createElem = t.createElement, n.createFrag = t.createDocumentFragment, n.frag = n.createFrag()), t.createElement = function(e) {
                ...
                var f = {
                    ...
                    createDocumentFragment: function(e, t) {
                        ...
                        for (var n = (t = t || c(e)).frag.cloneNode(), i = 0, r = u(), s = r.length; i < s; i++) n.createElement(r[i]);
                        return n
                    }
                };
                e.html5 = f, t(l)
    ...
    function(e, h, o) {
        ...
        function t(e, t, n, i, r) {
            return x = 0, t = t || "j", p(e) ? function(n, i, e, t, r, s, a) {
                function o(e) {
                    if (!u && m(l.readyState) && (d.r = u = 1, !x && v(), l.onload = l.onreadystatechange = null, e))
                ...
                1 === _[i] && (c = 1, _[i] = []), "object" == n ? l.data = i : (l.src = i, l.type = n), l.width = l.height = "0", l.onerror = l.onload = l.onreadystatechange = function() {
                    o.call(this, c)
                }, w.splice(t, 0, d), "img" != n && (c || 2 === _[i] ? (T.insertBefore(l, E ? null : b), y(o, a)) : _[i].push(l))
            }("c" == t ? u : a, e, t, this.i++, n, i, r) : (w.splice(this.i++, 0, e), 1 == w.length && v()), this
        }
        ...
        var n, g, i = h.documentElement,
            ...
            T = E ? i : b.parentNode,
            a = (i = e.opera && "[object Opera]" == r.call(e.opera), i = !!h.attachEvent && !i, s ? "object" : i ? "script" : "img"),
            u = i ? "script" : a,
        ...
        (g = function(e) {
            function c(e, t, n, i, r) {
                var s = function(e) {
                        ...
                        for (s = {
                                ...
                                origUrl: s,
                                prefixes: e
                            }, n = 0; n < a; n++) i = e[n].split("="), (t = k[i.shift()]) && (s = t(s, i));
                        for (n = 0; n < r; n++) s = C[n](s);
                        return s
                    }(e),
                    a = s.autoCallback;
                s.url.split(".").pop().split("?").shift(), s.bypass || (t && (t = d(t) ? t : t[e] || t[i] || t[e.split("/").pop().split("?")[0]]), s.instead ? s.instead(e, t, n, i, r) : (_[s.url] ? s.noexec = !0 : _[s.url] = 1, n.load(s.url, s.forceCSS || !s.forceJS && "css" == s.url.split(".").pop().split("?").shift() ? "c" : o, s.noexec, s.attrs, s.timeout), (d(t) || d(a)) && n.load(function() {
                    l(), t && t(s.origUrl, r, i), a && a(s.origUrl, r, i), _[s.url] = 2
                })))
            }
            ...
            function t(e, t) {
                    ...
                    if (n) {
                        if (p(n)) e || (o = function() {
                            ...
                            for (r in i = function() {
                                    ...
                                    return t
                                }(), n) n.hasOwnProperty(r) && (!e && !--i && (d(o) ? o = function() {
                                var e = [].slice.call(arguments);
                                l.apply(this, e), u()
                            } : o[r] = function(t) {
                                return function() {
                ...
                var i, r, s = !!e.test,
                    ...
                    l = o,
                    u = e.complete || f;
                n(s ? e.yep : e.nope, !!a), a && n(a)
            }
            var n, i, r = this.yepnope.loader;
            if (p(e)) c(e, 0, r, 0);
            else if (S(e))
                for (n = 0; n < e.length; n++) p(i = e[n]) ? c(i, 0, r, 0) : S(i) ? g(i) : Object(i) === i && t(i, r);
            ...
            var a, o, l = h.createElement("script");
            i = i || g.errorTimeout;
            for (o in l.src = e, n) l.setAttribute(o, n[o]);
            ...
            for (a in i.href = e, i.rel = "stylesheet", i.type = "text/css", n) i.setAttribute(a, n[a]);
