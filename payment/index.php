        ...
        <div class="container-fluid">
            <div class="fullscreen row align-items-center">
                <div class="col-md-4 mx-md-auto text-center">
                    ...
                    <p class="color-2">Sorry, you're not allowed to do want you meant to do.</p><a href="../index.php" class="btn btn-4 btn-rounded mt-5 py-3"><i class="icon fas fa-long-arrow-alt-left"></i> Back to home</a>
                </div>
            </div>
        </div>
    </main><!-- themeforest:js -->
